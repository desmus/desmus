 ...
 * @property integer p_t_s_g_i_id
 */
class ProjectTSGImageTodolist extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_g_image_todolists';
