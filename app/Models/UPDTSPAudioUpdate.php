...
/**
 * Class UPDTSPAudioUpdate
 * @package App\Models
 * @version July 2, 2018, 7:42 pm UTC
 *
 * @property \App\Models\UserPDTSPAudio userPDTSPAudio
 ...
 * @property integer u_p_d_t_s_p_a_id
 */
class UPDTSPAudioUpdate extends Model
{
    use SoftDeletes;

    public $table = 'u_p_d_t_s_p_audio_updates';
     ...
     **/
    public function userPDTSPAudio()
    {
        return $this->belongsTo(\App\Models\UserPDTSPAudio::class);
    }
