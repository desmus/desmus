...
/**
 * Class UserPersonalDataTSGalerieC
 * @package App\Models
 * @version June 18, 2018, 8:54 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSGalery userPersonalDataTSGalery
 ...
 */
class UserPersonalDataTSGalerieC extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_galerie_c';
     ...
     **/
    public function userPersonalDataTSGalery()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSGalery::class);
    }
