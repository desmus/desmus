...
class PublicFile extends Model
{
     ...
     **/
    public function publicFileComments()
    {
        return $this->hasMany(\App\Models\PublicFileComment::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function publicFileLikes()
    {
        return $this->hasMany(\App\Models\PublicFileLike::class);
    }
}
