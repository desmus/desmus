 ...
 * @property \App\Models\UserProject userProject
 ...
 * @property integer user_p_id
 */
class UserProjectU extends Model
{
    use SoftDeletes;

    public $table = 'user_project_u';
    ...
    {
        return $this->belongsTo(\App\Models\UserProject::class);
    }
}
