...
/**
 * Class PersonalDataTSNoteTodolist
 * @package App\Models
 ...
 * @property integer p_d_t_s_n_id
 */
class PersonalDataTSNoteTodolist extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_n_todolists';
