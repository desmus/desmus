...
/**
 * Class PublicNoteCommentResponse
 * @package App\Models
 * @version December 19, 2018, 5:23 pm UTC
 *
 * @property \App\Models\PublicNoteComment publicNoteComment
 ...
 * @property integer public_note_comment_id
 * @property integer user_id
 */
class PublicNoteCommentResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_note_comment_response';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_note_comment_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicNoteComment()
    {
        return $this->belongsTo(\App\Models\PublicNoteComment::class);
    }
