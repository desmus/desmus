 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSGaleryImage
 ...
 * @property integer personal_data_t_s_id
 */
class PersonalDataTSGalerie extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_galeries';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSGaleryImages()
    {
        return $this->hasMany(\App\Models\PersonalDataTSGaleryImage::class);
    }
