...
class PublicAudio extends Model
{
     ...
     **/
    public function publicAudioComments()
    {
        return $this->hasMany(\App\Models\PublicAudioComment::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function publicAudioLikes()
    {
        return $this->hasMany(\App\Models\PublicAudioLike::class);
    }
}
