...
/**
 * Class CollegeTSGaleryDelete
 * @package App\Models
 * @version May 5, 2018, 10:55 pm UTC
 *
 * @property \App\Models\CollegeTSGalery collegeTSGalery
 ...
 * @property integer college_t_s_galery_id
 */
class CollegeTSGaleryDelete extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_galery_deletes';
     ...
     **/
    public function collegeTSGalery()
    {
        return $this->belongsTo(\App\Models\CollegeTSGalery::class);
    }
