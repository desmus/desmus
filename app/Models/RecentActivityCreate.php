...
/**
 * Class RecentActivityCreate
 * @package App\Models
 * @version June 13, 2018, 6:23 pm UTC
 *
 * @property \App\Models\RecentActivity recentActivity
 ...
 * @property integer recent_activity_id
 */
class RecentActivityCreate extends Model
{
    use SoftDeletes;

    public $table = 'recent_activity_creates';
    ...
    {
        return $this->belongsTo(\App\Models\RecentActivity::class);
    }
