...
/**
 * Class CollegeTSGImageTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\CollegeTSGImageTodolist collegeTSGImageTodolist
 ...
 * @property integer c_t_s_g_i_t_id
 */
class CollegeTSGImageTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_g_image_todolist_creates';
     ...
     **/
    public function collegeTSGImageTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSGImageTodolist::class);
    }
