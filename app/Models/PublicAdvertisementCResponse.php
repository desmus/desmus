...
/**
 * Class PublicAdvertisementCResponse
 * @package App\Models
 * @version December 19, 2018, 5:24 pm UTC
 *
 * @property \App\Models\PublicAdvertisementComment publicAdvertisementComment
 ...
 * @property integer public_a_c_id
 * @property integer user_id
 */
class PublicAdvertisementCResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_advertisement_c_response';
     ...
     **/
    public function publicAdvertisementComment()
    {
        return $this->belongsTo(\App\Models\PublicAdvertisementComment::class);
    }
