...
/**
 * Class ContactSocialUpdates
 * @package App\Models
 * @version July 9, 2018, 9:21 pm UTC
 *
 * @property \App\Models\ContactSocial contactSocial
 ...
 * @property integer contact_social_id
 */
class ContactSocialUpdates extends Model
{
    use SoftDeletes;

    public $table = 'contact_social_updates';
    ...
    {
        return $this->belongsTo(\App\Models\ContactSocial::class);
    }
