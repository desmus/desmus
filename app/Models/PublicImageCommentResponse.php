...
/**
 * Class PublicImageCommentResponse
 * @package App\Models
 * @version December 19, 2018, 5:23 pm UTC
 *
 * @property \App\Models\PublicImageComment publicImageComment
 ...
 * @property integer public_image_comment_id
 * @property integer user_id
 */
class PublicImageCommentResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_image_comment_response';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_image_comment_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicImageComment()
    {
        return $this->belongsTo(\App\Models\PublicImageComment::class);
    }
