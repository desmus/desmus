 ...
 *
 * @property \App\Models\JobTopicSection jobTopicSection
 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSPlaylistCreate
 * @property \Illuminate\Database\Eloquent\Collection JobTSPlaylistDelete
 * @property \Illuminate\Database\Eloquent\Collection JobTSPlaylistUpdate
 * @property \Illuminate\Database\Eloquent\Collection JobTSPlaylistView
 ...
 * @property integer j_t_s_id
 */
class JobTSPlaylist extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_playlists';
     ...
     **/
    public function jobTopicSection()
    {
        return $this->belongsTo(\App\Models\JobTopicSection::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSPlaylistCreates()
    {
        return $this->hasMany(\App\Models\JobTSPlaylistCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSPlaylistDeletes()
    {
        return $this->hasMany(\App\Models\JobTSPlaylistDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSPlaylistUpdates()
    {
        return $this->hasMany(\App\Models\JobTSPlaylistUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSPlaylistViews()
    {
        return $this->hasMany(\App\Models\JobTSPlaylistView::class);
    }
}
