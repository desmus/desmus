...
/**
 * Class PublicFileComment
 * @package App\Models
 * @version December 19, 2018, 5:22 pm UTC
 *
 * @property \App\Models\PublicFile publicFile
 ...
 * @property integer public_file_id
 * @property integer user_id
 */
class PublicFileComment extends Model
{
    use SoftDeletes;

    public $table = 'public_file_comment';
    ...
    {
        return $this->belongsTo(\App\Models\PublicFile::class);
    }
     ...
     **/
    public function publicFileCommentResponses()
    {
        return $this->hasMany(\App\Models\PublicFileCommentResponse::class);
    }
}
