...
/**
 * Class PublicAudioCommentResponse
 * @package App\Models
 * @version December 19, 2018, 5:23 pm UTC
 *
 * @property \App\Models\PublicAudioComment publicAudioComment
 ...
 * @property integer public_audio_comment_id
 * @property integer user_id
 */
class PublicAudioCommentResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_audio_comment_response';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_audio_comment_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicAudioComment()
    {
        return $this->belongsTo(\App\Models\PublicAudioComment::class);
    }
