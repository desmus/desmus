...
/**
 * Class SharedProfileVideoC
 * @package App\Models
 * @version April 11, 2019, 3:29 pm UTC
 *
 * @property \App\Models\SharedProfileVideo sharedProfileVideo
 ...
 * @property integer s_p_v_id
 * @property integer user_id
 */
class SharedProfileVideoC extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_video_c';
     ...
     **/
    public function sharedProfileVideo()
    {
        return $this->belongsTo(\App\Models\SharedProfileVideo::class);
    }
     ...
     **/
    public function sharedProfileVideoCResponses()
    {
        return $this->hasMany(\App\Models\SharedProfileVideoCResponse::class);
    }
}
