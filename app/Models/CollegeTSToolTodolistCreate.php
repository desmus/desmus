...
/**
 * Class CollegeTSToolTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\CollegeTSToolTodolist collegeTSToolTodolist
 ...
 * @property integer c_t_s_t_t_id
 */
class CollegeTSToolTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_todolist_creates';
     ...
     **/
    public function collegeTSToolTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSToolTodolist::class);
    }
