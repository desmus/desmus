...
/**
 * Class ProjectTSPTDelete
 * @package App\Models
 * @version July 2, 2018, 3:36 am UTC
 *
 * @property \App\Models\ProjectTSPTodolist projectTSPTodolist
 ...
 * @property integer p_t_s_p_t_id
 */
class ProjectTSPTDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_p_t_deletes';
     ...
     **/
    public function projectTSPTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSPTodolist::class);
    }
