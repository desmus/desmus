 ...
 * @property integer public_note_id
 * @property integer user_id
 */
class PublicNoteComment extends Model
{
    use SoftDeletes;

    public $table = 'public_note_comment';
    ...
    {
        return $this->belongsTo(\App\Models\PublicNote::class);
    }
     ...
     **/
    public function publicNoteCommentResponses()
    {
        return $this->hasMany(\App\Models\PublicNoteCommentResponse::class);
    }
}
