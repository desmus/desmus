...
/**
 * Class UserJobTSToolFileD
 * @package App\Models
 * @version June 18, 2018, 9:08 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSToolFile userJobTSToolFile
 ...
 * @property integer user_j_t_s_t_f_id
 */
class UserJobTSToolFileD extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_tool_file_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSToolFile()
    {
        return $this->belongsTo(\App\Models\UserJobTSToolFile::class);
    }
}
