...
/**
 * Class UserJobTSFileD
 * @package App\Models
 * @version June 18, 2018, 9:03 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSFile userJobTSFile
 ...
 * @property integer user_j_t_s_f_id
 */
class UserJobTSFileD extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_file_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSFile()
    {
        return $this->belongsTo(\App\Models\UserJobTSFile::class);
    }
}
