...
/**
 * Class UserSharedProfileCreate
 * @package App\Models
 * @version April 23, 2019, 10:47 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserSharedProfile userSharedProfile
 ...
 * @property integer user_shared_profile_id
 */
class UserSharedProfileCreate extends Model
{
    use SoftDeletes;

    public $table = 'user_shared_profile_creates';
    ...
    protected $casts = [
        'id' => 'integer',
        'user_id' => 'integer',
        'user_shared_profile_id' => 'integer'
    ];
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userSharedProfile()
    {
        return $this->belongsTo(\App\Models\UserSharedProfile::class);
    }
}
