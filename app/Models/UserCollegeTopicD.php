...
/**
 * Class UserCollegeTopicD
 * @package App\Models
 * @version June 18, 2018, 9:02 pm UTC
 *
 * @property \App\Models\UserCollegeTopic userCollegeTopic
 ...
 * @property integer user_c_t_id
 */
class UserCollegeTopicD extends Model
{
    use SoftDeletes;

    public $table = 'user_college_topic_d';
     ...
     **/
    public function userCollegeTopic()
    {
        return $this->belongsTo(\App\Models\UserCollegeTopic::class);
    }
