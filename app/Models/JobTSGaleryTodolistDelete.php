...
/**
 * Class JobTSGaleryTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\JobTSGaleryTodolist jobTSGaleryTodolist
 ...
 * @property integer j_t_s_g_t_id
 */
class JobTSGaleryTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_galery_todolist_deletes';
     ...
     **/
    public function jobTSGaleryTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSGaleryTodolist::class);
    }
