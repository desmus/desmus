...
/**
 * Class PersonalDataTopicTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\PersonalDataTopicTodolist personalDataTopicTodolist
 ...
 * @property integer p_d_c_t_t_id
 */
class PersonalDataTopicTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_topic_todolist_deletes';
     ...
     **/
    public function personalDataTopicTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTopicTodolist::class);
    }
