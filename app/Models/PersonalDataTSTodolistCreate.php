...
/**
 * Class PersonalDataTSTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:08 am UTC
 *
 * @property \App\Models\PersonalDataTSTodolist personalDataTSTodolist
 ...
 * @property integer p_d_t_s_t_id
 */
class PersonalDataTSTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_todolist_creates';
     ...
     **/
    public function personalDataTSTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSTodolist::class);
    }
