...
/**
 * Class PersonalDataTSTFTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\PersonalDataTSTFTodolist personalDataTSTFTodolist
 ...
 * @property integer p_d_t_s_t_f_t_id
 */
class PersonalDataTSTFTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_t_f_todolist_creates';
     ...
     **/
    public function personalDataTSTFTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSTFTodolist::class);
    }
