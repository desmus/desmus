...
/**
 * Class ProjectTSToolTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\ProjectTSToolTodolist projectTSToolTodolist
 ...
 * @property integer p_t_s_t_t_id
 */
class ProjectTSToolTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_todolist_creates';
     ...
     **/
    public function projectTSToolTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSToolTodolist::class);
    }
