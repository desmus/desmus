...
/**
 * Class PersonalDataTSGaleryDelete
 * @package App\Models
 ...
 * @property integer personal_d_t_s_g_id
 */
class PersonalDataTSGaleryDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_galery_deletes';
