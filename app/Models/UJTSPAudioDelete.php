...
/**
 * Class UJTSPAudioDelete
 * @package App\Models
 * @version July 2, 2018, 7:41 pm UTC
 *
 * @property \App\Models\UserJobTSPAudio userJobTSPAudio
 ...
 * @property integer u_j_t_s_p_a_id
 */
class UJTSPAudioDelete extends Model
{
    use SoftDeletes;

    public $table = 'u_j_t_s_p_audio_deletes';
     ...
     **/
    public function userJobTSPAudio()
    {
        return $this->belongsTo(\App\Models\UserJobTSPAudio::class);
    }
