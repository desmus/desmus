...
/**
 * Class UserCollegeTSFileC
 * @package App\Models
 * @version June 18, 2018, 8:53 pm UTC
 *
 * @property \App\Models\UserCollegeTSFile userCollegeTSFile
 ...
 * @property integer user_c_t_s_f_id
 */
class UserCollegeTSFileC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_file_c';
     ...
     **/
    public function userCollegeTSFile()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSFile::class);
    }
