 ...
 * @property integer j_t_s_t_f_id
 */
class JobTSToolFileTodolist extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_tool_file_todolists';
