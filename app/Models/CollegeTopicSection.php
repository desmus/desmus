...
/**
 * Class CollegeTopicSection
 * @package App\Models
 * @version May 5, 2018, 10:45 pm UTC
 *
 * @property \App\Models\CollegeTopic collegeTopic
 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSFile
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSGalery
 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSNote
 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSTool
 ...
 * @property string specific_info
 * @property integer views_quantity
 * @property integer updates_quantity
 * @property string status
 * @property integer college_topic_id
 */
class CollegeTopicSection extends Model
{
    use SoftDeletes;

    public $table = 'college_topic_sections';
     ...
     **/
    public function collegeTopic()
    {
        return $this->belongsTo(\App\Models\CollegeTopic::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSFiles()
    {
        return $this->hasMany(\App\Models\CollegeTSFile::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSGaleries()
    {
        return $this->hasMany(\App\Models\CollegeTSGalery::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSNotes()
    {
        return $this->hasMany(\App\Models\CollegeTSNote::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSTools()
    {
        return $this->hasMany(\App\Models\CollegeTSTool::class);
    }
