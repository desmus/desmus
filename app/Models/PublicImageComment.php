...
/**
 * Class PublicImageComment
 * @package App\Models
 * @version December 19, 2018, 5:23 pm UTC
 *
 * @property \App\Models\PublicImage publicImage
 ...
 * @property integer public_image_id
 * @property integer user_id
 */
class PublicImageComment extends Model
{
    use SoftDeletes;

    public $table = 'public_image_comment';
    ...
    {
        return $this->belongsTo(\App\Models\PublicImage::class);
    }
     ...
     **/
    public function publicImageCommentResponses()
    {
        return $this->hasMany(\App\Models\PublicImageCommentResponse::class);
    }
}
