...
/**
 * Class CollegeTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:07 am UTC
 *
 * @property \App\Models\CollegeTodolist collegeTodolist
 ...
 * @property integer c_t_id
 */
class CollegeTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_todolist_creates';
     ...
     **/
    public function collegeTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTodolist::class);
    }
