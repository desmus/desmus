...
/**
 * Class ProjectTSFileDelete
 * @package App\Models
 * @version May 5, 2018, 10:54 pm UTC
 *
 * @property \App\Models\ProjectTSFile projectTSFile
 ...
 * @property integer project_t_s_file_id
 */
class ProjectTSFileDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_file_deletes';
     ...
     **/
    public function projectTSFile()
    {
        return $this->belongsTo(\App\Models\ProjectTSFile::class);
    }
