...
/**
 * Class CollegeTSPTUpdate
 * @package App\Models
 * @version July 2, 2018, 3:35 am UTC
 *
 * @property \App\Models\CollegeTSPTodolist collegeTSPTodolist
 ...
 * @property integer c_t_s_p_t_id
 */
class CollegeTSPTUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_p_t_updates';
     ...
     **/
    public function collegeTSPTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSPTodolist::class);
    }
