 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTopicSection
 ...
 */
class CollegeTopic extends Model
{
    use SoftDeletes;

    public $table = 'college_topics';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTopicSections()
    {
        return $this->hasMany(\App\Models\CollegeTopicSection::class);
    }
