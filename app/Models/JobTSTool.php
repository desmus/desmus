 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSToolFile
 ...
 */
class JobTSTool extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_tools';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSToolFiles()
    {
        return $this->hasMany(\App\Models\JobTSToolFile::class);
    }
