...
/**
 * Class PublicAudioComment
 * @package App\Models
 * @version December 19, 2018, 5:23 pm UTC
 *
 * @property \App\Models\PublicAudio publicAudio
 ...
 * @property integer public_audio_id
 * @property integer user_id
 */
class PublicAudioComment extends Model
{
    use SoftDeletes;

    public $table = 'public_audio_comment';
     ...
     **/
    public function publicAudio()
    {
        return $this->belongsTo(\App\Models\PublicAudio::class);
    }
     ...
     **/
    public function publicAudioCommentResponses()
    {
        return $this->hasMany(\App\Models\PublicAudioCommentResponse::class);
    }
}
