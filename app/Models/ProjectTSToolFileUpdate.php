...
/**
 * Class ProjectTSToolFileUpdate
 * @package App\Models
 * @version May 5, 2018, 10:52 pm UTC
 *
 * @property \App\Models\ProjectTSToolFile projectTSToolFile
 ...
 * @property integer project_t_s_t_file_id
 */
class ProjectTSToolFileUpdate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_file_updates';
     ...
     **/
    public function projectTSToolFile()
    {
        return $this->belongsTo(\App\Models\ProjectTSToolFile::class);
    }
