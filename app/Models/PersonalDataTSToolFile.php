 ...
 * @property integer personal_data_t_s_t_id
 */
class PersonalDataTSToolFile extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_tool_files';
    ...
    protected $casts = [
        ...
        'status' => 'string',
        'personal_data_t_s_t_id' => 'integer'
    ];
