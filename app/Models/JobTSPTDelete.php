 ...
 *
 * @property \App\Models\JobTSPTodolist jobTSPTodolist
 ...
 * @property integer j_t_s_p_t_id
 */
class JobTSPTDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_p_t_deletes';
     ...
     **/
    public function jobTSPTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSPTodolist::class);
    }
