 ...
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileImageUpdate
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileImageView
 ...
 */
class SharedProfileImage extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_image';
     ...
     **/
    public function sharedProfileImageCs()
    {
        return $this->hasMany(\App\Models\SharedProfileImageC::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileImageLikes()
    {
        return $this->hasMany(\App\Models\SharedProfileImageLike::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileImageUpdates()
    {
        return $this->hasMany(\App\Models\SharedProfileImageUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileImageViews()
    {
        return $this->hasMany(\App\Models\SharedProfileImageView::class);
    }
}
