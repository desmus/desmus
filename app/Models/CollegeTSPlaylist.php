...
/**
 * Class CollegeTSPlaylist
 * @package App\Models
 * @version June 29, 2018, 7:06 pm UTC
 *
 * @property \App\Models\CollegeTopicSection collegeTopicSection
 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSPlaylistCreate
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSPlaylistDelete
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSPlaylistUpdate
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSPlaylistView
 ...
 * @property integer c_t_s_id
 */
class CollegeTSPlaylist extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_playlists';
     ...
     **/
    public function collegeTopicSection()
    {
        return $this->belongsTo(\App\Models\CollegeTopicSection::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSPlaylistCreates()
    {
        return $this->hasMany(\App\Models\CollegeTSPlaylistCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSPlaylistDeletes()
    {
        return $this->hasMany(\App\Models\CollegeTSPlaylistDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSPlaylistUpdates()
    {
        return $this->hasMany(\App\Models\CollegeTSPlaylistUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSPlaylistViews()
    {
        return $this->hasMany(\App\Models\CollegeTSPlaylistView::class);
    }
}
