...
/**
 * Class SharedProfileImageCResponse
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileImageC sharedProfileImageC
 ...
 * @property integer s_p_i_c_id
 * @property integer user_id
 */
class SharedProfileImageCResponse extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_image_c_response';
     ...
     **/
    public function sharedProfileImageC()
    {
        return $this->belongsTo(\App\Models\SharedProfileImageC::class);
    }
