...
/**
 * Class JobTSFileTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:08 am UTC
 *
 * @property \App\Models\JobTSFileTodolist jobTSFileTodolist
 ...
 * @property integer j_t_s_f_t_id
 */
class JobTSFileTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_file_todolist_creates';
     ...
     **/
    public function jobTSFileTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSFileTodolist::class);
    }
