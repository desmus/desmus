...
/**
 * Class JobTSGaleryImageDelete
 * @package App\Models
 * @version May 19, 2018, 8:44 pm UTC
 *
 * @property \App\Models\JobTSGaleryImage jobTSGaleryImage
 ...
 * @property integer job_t_s_g_image_id
 */
class JobTSGaleryImageDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_galery_image_deletes';
     ...
     **/
    public function jobTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\JobTSGaleryImage::class);
    }
