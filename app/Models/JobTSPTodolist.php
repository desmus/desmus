...
/**
 * Class JobTSPTodolist
 * @package App\Models
 * @version July 2, 2018, 3:35 am UTC
 *
 * @property \App\Models\JobTSPlaylist jobTSPlaylist
 ...
 * @property integer j_t_s_p_id
 */
class JobTSPTodolist extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_p_todolists';
     ...
     **/
    public function jobTSPlaylist()
    {
        return $this->belongsTo(\App\Models\JobTSPlaylist::class);
    }
