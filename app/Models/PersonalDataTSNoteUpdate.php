...
/**
 * Class PersonalDataTSNoteUpdate
 * @package App\Models
 * @version May 5, 2018, 10:51 pm UTC
 *
 * @property \App\Models\PersonalDataTSNote personalDataTSNote
 ...
 * @property integer personal_data_t_s_note_id
 */
class PersonalDataTSNoteUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_note_updates';
    ...
    protected $casts = [
        ...
        'past_name' => 'string',
        'user_id' => 'integer',
        'personal_data_t_s_note_id' => 'integer'
    ];
     ...
     **/
    public function personalDataTSNote()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSNote::class);
    }
