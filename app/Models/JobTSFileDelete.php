...
/**
 * Class JobTSFileDelete
 * @package App\Models
 * @version May 5, 2018, 10:54 pm UTC
 *
 * @property \App\Models\JobTSFile jobTSFile
 ...
 * @property integer job_t_s_file_id
 */
class JobTSFileDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_file_deletes';
     ...
     **/
    public function jobTSFile()
    {
        return $this->belongsTo(\App\Models\JobTSFile::class);
    }
