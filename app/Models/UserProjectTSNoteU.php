...
/**
 * Class UserProjectTSNoteU
 * @package App\Models
 * @version June 18, 2018, 9:00 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSNote userProjectTSNote
 ...
 * @property integer user_p_t_s_n_id
 */
class UserProjectTSNoteU extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_note_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSNote()
    {
        return $this->belongsTo(\App\Models\UserProjectTSNote::class);
    }
}
