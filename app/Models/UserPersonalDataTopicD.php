...
/**
 * Class UserPersonalDataTopicD
 * @package App\Models
 * @version June 18, 2018, 9:03 pm UTC
 *
 * @property \App\Models\UserPersonalDataTopic userPersonalDataTopic
 ...
 */
class UserPersonalDataTopicD extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_topic_d';
     ...
     **/
    public function userPersonalDataTopic()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTopic::class);
    }
