...
/**
 * Class PersonalDataTSFileCreate
 * @package App\Models
 * @version May 5, 2018, 10:48 pm UTC
 *
 * @property \App\Models\PersonalDataTSFile personalDataTSFile
 ...
 * @property integer personal_data_t_s_file_id
 */
class PersonalDataTSFileCreate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_file_creates';
    ...
    protected $casts = [
        'id' => 'integer',
        'user_id' => 'integer',
        'personal_data_t_s_file_id' => 'integer'
    ];
     ...
     **/
    public function personalDataTSFile()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSFile::class);
    }
