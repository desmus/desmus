...
/**
 * Class ProjectTSGaleryImageUpdate
 * @package App\Models
 * @version May 5, 2018, 10:52 pm UTC
 *
 * @property \App\Models\ProjectTSGaleryImage projectTSGaleryImage
 ...
 * @property integer project_t_s_g_image_id
 */
class ProjectTSGaleryImageUpdate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_galery_image_updates';
    ...
    protected $casts = [
        ...
        'past_name' => 'string',
        'user_id' => 'integer',
        'project_t_s_g_image_id' => 'integer'
    ];
     ...
     **/
    public function projectTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\ProjectTSGaleryImage::class);
    }
