...
/**
 * Class SharedProfileImageC
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileImage sharedProfileImage
 ...
 * @property integer s_p_i_id
 * @property integer user_id
 */
class SharedProfileImageC extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_image_c';
     ...
     **/
    public function sharedProfileImage()
    {
        return $this->belongsTo(\App\Models\SharedProfileImage::class);
    }
     ...
     **/
    public function sharedProfileImageCResponses()
    {
        return $this->hasMany(\App\Models\SharedProfileImageCResponse::class);
    }
}
