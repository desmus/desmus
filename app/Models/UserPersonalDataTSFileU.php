...
/**
 * Class UserPersonalDataTSFileU
 * @package App\Models
 * @version June 18, 2018, 9:00 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSFile userPersonalDataTSFile
 ...
 */
class UserPersonalDataTSFileU extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_file_u';
     ...
     **/
    public function userPersonalDataTSFile()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSFile::class);
    }
