...
/**
 * Class UserProjectTSToolFileD
 * @package App\Models
 * @version June 18, 2018, 9:08 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSToolFile userProjectTSToolFile
 ...
 * @property integer user_p_t_s_t_f_id
 */
class UserProjectTSToolFileD extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_tool_file_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSToolFile()
    {
        return $this->belongsTo(\App\Models\UserProjectTSToolFile::class);
    }
}
