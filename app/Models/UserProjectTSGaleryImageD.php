...
/**
 * Class UserProjectTSGaleryImageD
 * @package App\Models
 * @version June 18, 2018, 9:07 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSGaleryImage userProjectTSGaleryImage
 ...
 * @property integer user_p_t_s_g_i_id
 */
class UserProjectTSGaleryImageD extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_galery_image_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\UserProjectTSGaleryImage::class);
    }
}
