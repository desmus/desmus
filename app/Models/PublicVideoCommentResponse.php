...
/**
 * Class PublicVideoCommentResponse
 * @package App\Models
 * @version January 9, 2019, 11:10 pm UTC
 *
 * @property \App\Models\PublicVideoComment publicVideoComment
 ...
 * @property integer public_video_comment_id
 * @property integer user_id
 */
class PublicVideoCommentResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_video_comment_response';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_video_comment_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicVideoComment()
    {
        return $this->belongsTo(\App\Models\PublicVideoComment::class);
    }
