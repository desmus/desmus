 ...
 *
 * @property \App\Models\CalendarEvent calendarEvent
 ...
 * @property \Illuminate\Database\Eloquent\Collection UserCalendarEventCreate
 * @property \Illuminate\Database\Eloquent\Collection UserCalendarEventDelete
 * @property \Illuminate\Database\Eloquent\Collection UserCalendarEventUpdate
...
class UserCalendarEvent extends Model
{
    ...
    public $table = 'user_calendar_events';
    ...
    {
        return $this->belongsTo(\App\Models\CalendarEvent::class);
    }
     ...
     **/
    public function userCalendarEventCreates()
    {
        return $this->hasMany(\App\Models\UserCalendarEventCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function userCalendarEventDeletes()
    {
        return $this->hasMany(\App\Models\UserCalendarEventDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function userCalendarEventUpdates()
    {
        return $this->hasMany(\App\Models\UserCalendarEventUpdate::class);
    }
}
