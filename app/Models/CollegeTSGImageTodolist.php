 ...
 * @property integer c_t_s_g_i_id
 */
class CollegeTSGImageTodolist extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_g_image_todolists';
