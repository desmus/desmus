 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSFile
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSGalery
 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSNote
 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSTool
 ...
 */
class ProjectTopicSection extends Model
{
    use SoftDeletes;

    public $table = 'project_topic_sections';
     ...
     **/
    public function projectTSFiles()
    {
        return $this->hasMany(\App\Models\ProjectTSFile::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSGaleries()
    {
        return $this->hasMany(\App\Models\ProjectTSGalery::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSNotes()
    {
        return $this->hasMany(\App\Models\ProjectTSNote::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSTools()
    {
        return $this->hasMany(\App\Models\ProjectTSTool::class);
    }
