 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTopicSection
 ...
 */
class JobTopic extends Model
{
    use SoftDeletes;

    public $table = 'job_topics';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTopicSections()
    {
        return $this->hasMany(\App\Models\JobTopicSection::class);
    }
