 ...
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileVideoUpdate
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileVideoView
 ...
 */
class SharedProfileVideo extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_video';
     ...
     **/
    public function sharedProfileVideoCs()
    {
        return $this->hasMany(\App\Models\SharedProfileVideoC::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileVideoLikes()
    {
        return $this->hasMany(\App\Models\SharedProfileVideoLike::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileVideoUpdates()
    {
        return $this->hasMany(\App\Models\SharedProfileVideoUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileVideoViews()
    {
        return $this->hasMany(\App\Models\SharedProfileVideoView::class);
    }
}
