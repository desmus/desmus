...
/**
 * Class UserProjectTSGalerieC
 * @package App\Models
 * @version June 18, 2018, 8:54 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSGalery userProjectTSGalery
 ...
 * @property integer user_p_t_s_g_id
 */
class UserProjectTSGalerieC extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_galerie_c';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSGalery()
    {
        return $this->belongsTo(\App\Models\UserProjectTSGalery::class);
    }
}
