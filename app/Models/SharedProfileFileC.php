...
/**
 * Class SharedProfileFileC
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileFile sharedProfileFile
 ...
 * @property integer s_p_f_id
 * @property integer user_id
 */
class SharedProfileFileC extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_file_c';
     ...
     **/
    public function sharedProfileFile()
    {
        return $this->belongsTo(\App\Models\SharedProfileFile::class);
    }
     ...
     **/
    public function sharedProfileFileCResponses()
    {
        return $this->hasMany(\App\Models\SharedProfileFileCResponse::class);
    }
}
