...
/**
 * Class SharedProfileFileCResponse
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileFileC sharedProfileFileC
 ...
 * @property integer s_p_f_c_id
 * @property integer user_id
 */
class SharedProfileFileCResponse extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_file_c_response';
     ...
     **/
    public function sharedProfileFileC()
    {
        return $this->belongsTo(\App\Models\SharedProfileFileC::class);
    }
