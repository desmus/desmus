...
/**
 * Class CollegeTopicSectionTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:07 am UTC
 *
 * @property \App\Models\CollegeTopicSectionTodolist collegeTopicSectionTodolist
 ...
 * @property integer c_t_s_t_id
 */
class CollegeTopicSectionTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_topic_section_todolist_creates';
     ...
     **/
    public function collegeTopicSectionTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTopicSectionTodolist::class);
    }
