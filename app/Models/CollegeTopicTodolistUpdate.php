...
/**
 * Class CollegeTopicTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:13 am UTC
 *
 * @property \App\Models\CollegeTopicTodolist collegeTopicTodolist
 ...
 * @property integer c_t_t_id
 */
class CollegeTopicTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_topic_todolist_updates';
     ...
     **/
    public function collegeTopicTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTopicTodolist::class);
    }
