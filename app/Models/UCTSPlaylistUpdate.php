...
/**
 * Class UCTSPlaylistUpdate
 * @package App\Models
 * @version June 30, 2018, 4:50 am UTC
 *
 * @property \App\Models\UserPersonalDataTSP userPersonalDataTSP
 ...
 * @property integer u_p_d_t_s_p_id
 */
class UCTSPlaylistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'u_p_d_t_s_playlist_updates';
     ...
     **/
    public function userPersonalDataTSP()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSP::class);
    }
