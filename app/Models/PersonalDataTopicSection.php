...
/**
 * Class PersonalDataTopicSection
 * @package App\Models
 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSFile
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSGalery
 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSNote
 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSTool
 ...
 * @property integer personal_data_topic_id
 */
class PersonalDataTopicSection extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_topic_sections';
     ...
     **/
    public function personalDataTSFiles()
    {
        return $this->hasMany(\App\Models\PersonalDataTSFile::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSGaleries()
    {
        return $this->hasMany(\App\Models\PersonalDataTSGalery::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSNotes()
    {
        return $this->hasMany(\App\Models\PersonalDataTSNote::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSTools()
    {
        return $this->hasMany(\App\Models\PersonalDataTSTool::class);
    }
