...
class PublicNote extends Model
{
     ...
     **/
    public function publicNoteComments()
    {
        return $this->hasMany(\App\Models\PublicNoteComment::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function publicNoteLikes()
    {
        return $this->hasMany(\App\Models\PublicNoteLike::class);
    }
}
