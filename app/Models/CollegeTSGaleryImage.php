 ...
 * @property integer college_t_s_g_id
 */
class CollegeTSGaleryImage extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_galery_images';
