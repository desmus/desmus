...
/**
 * Class SharedProfileAudioC
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileAudio sharedProfileAudio
 ...
 * @property integer s_p_a_id
 * @property integer user_id
 */
class SharedProfileAudioC extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_audio_c';
     ...
     **/
    public function sharedProfileAudio()
    {
        return $this->belongsTo(\App\Models\SharedProfileAudio::class);
    }
     ...
     **/
    public function sharedProfileAudioCResponses()
    {
        return $this->hasMany(\App\Models\SharedProfileAudioCResponse::class);
    }
}
