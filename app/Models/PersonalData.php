 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTopic
...
class PersonalData extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTopics()
    {
        return $this->hasMany(\App\Models\PersonalDataTopic::class);
    }
