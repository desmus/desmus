...
/**
 * Class JobTopicSection
 * @package App\Models
 * @version May 5, 2018, 10:45 pm UTC
 *
 * @property \App\Models\JobTopic jobTopic
 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSFile
 * @property \Illuminate\Database\Eloquent\Collection JobTSGalery
 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSNote
 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSTool
 ...
 * @property integer job_topic_id
 */
class JobTopicSection extends Model
{
    use SoftDeletes;

    public $table = 'job_topic_sections';
     ...
     **/
    public function jobTopic()
    {
        return $this->belongsTo(\App\Models\JobTopic::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSFiles()
    {
        return $this->hasMany(\App\Models\JobTSFile::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSGaleries()
    {
        return $this->hasMany(\App\Models\JobTSGalery::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSNotes()
    {
        return $this->hasMany(\App\Models\JobTSNote::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSTools()
    {
        return $this->hasMany(\App\Models\JobTSTool::class);
    }
