...
/**
 * Class CollegeTSPAudioUpdate
 * @package App\Models
 * @version July 1, 2018, 6:57 am UTC
 *
 * @property \App\Models\CollegeTSPAudio collegeTSPAudio
 ...
 * @property integer c_t_s_p_a_id
 */
class CollegeTSPAudioUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_p_audio_updates';
     ...
     **/
    public function collegeTSPAudio()
    {
        return $this->belongsTo(\App\Models\CollegeTSPAudio::class);
    }
