...
/**
 * Class ProjectTSNoteTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:08 am UTC
 *
 * @property \App\Models\ProjectTSNoteTodolist projectTSNoteTodolist
 ...
 * @property integer p_t_s_n_t_id
 */
class ProjectTSNoteTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_note_todolist_creates';
     ...
     **/
    public function projectTSNoteTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSNoteTodolist::class);
    }
