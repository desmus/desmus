 ...
 * @property integer project_t_s_t_id
 */
class ProjectTSToolFile extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_files';
