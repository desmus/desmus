...
/**
 * Class PersonalDataTSToolFileUpdate
 * @package App\Models
 ...
 * @property integer p_d_t_s_t_f_id
 */
class PersonalDataTSToolFileUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_tool_file_updates';
