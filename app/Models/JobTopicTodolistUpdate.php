...
/**
 * Class JobTopicTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:13 am UTC
 *
 * @property \App\Models\JobTopicTodolist jobTopicTodolist
 ...
 * @property integer j_t_t_id
 */
class JobTopicTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'job_topic_todolist_updates';
     ...
     **/
    public function jobTopicTodolist()
    {
        return $this->belongsTo(\App\Models\JobTopicTodolist::class);
    }
