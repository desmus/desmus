...
/**
 * Class UserJobTopicSectionC
 * @package App\Models
 * @version June 18, 2018, 8:53 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTopicSection userJobTopicSection
 ...
 * @property integer user_j_t_s_id
 */
class UserJobTopicSectionC extends Model
{
    use SoftDeletes;

    public $table = 'user_job_topic_section_c';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTopicSection()
    {
        return $this->belongsTo(\App\Models\UserJobTopicSection::class);
    }
}
