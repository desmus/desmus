...
/**
 * Class PDTSPAudioUpdate
 * @package App\Models
 * @version July 1, 2018, 7:04 am UTC
 *
 * @property \App\Models\PersonalDataTSPAudio personalDataTSPAudio
 ...
 * @property integer p_d_t_s_p_a_id
 */
class PDTSPAudioUpdate extends Model
{
    use SoftDeletes;

    public $table = 'p_d_t_s_p_audio_updates';
     ...
     **/
    public function personalDataTSPAudio()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSPAudio::class);
    }
