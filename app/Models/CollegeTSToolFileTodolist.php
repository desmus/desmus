...
/**
 * Class CollegeTSToolFileTodolist
 * @package App\Models
 ...
 * @property integer c_t_s_t_f_id
 */
class CollegeTSToolFileTodolist extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_file_todolists';
