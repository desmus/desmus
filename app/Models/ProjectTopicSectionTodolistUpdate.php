...
/**
 * Class ProjectTopicSectionTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:13 am UTC
 *
 * @property \App\Models\ProjectTopicSectionTodolist projectTopicSectionTodolist
 ...
 * @property integer p_t_s_t_id
 */
class ProjectTopicSectionTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'project_topic_section_todolist_updates';
     ...
     **/
    public function projectTopicSectionTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTopicSectionTodolist::class);
    }
