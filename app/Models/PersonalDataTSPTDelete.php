...
/**
 * Class PersonalDataTSPTDelete
 * @package App\Models
 * @version July 2, 2018, 3:37 am UTC
 *
 * @property \App\Models\PersonalDataTSPTodolist personalDataTSPTodolist
 ...
 * @property \Illuminate\Database\Eloquent\Collection personalDataTSPAudios
 ...
 * @property integer p_d_t_s_p_t_id
 */
class PersonalDataTSPTDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_p_t_deletes';
     ...
     **/
    public function personalDataTSPTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSPTodolist::class);
    }
