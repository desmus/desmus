...
/**
 * Class JobTSToolDelete
 * @package App\Models
 * @version May 5, 2018, 10:55 pm UTC
 *
 * @property \App\Models\JobTSTool jobTSTool
 ...
 * @property integer job_t_s_tool_id
 */
class JobTSToolDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_tool_deletes';
     ...
     **/
    public function jobTSTool()
    {
        return $this->belongsTo(\App\Models\JobTSTool::class);
    }
