 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSToolFile
 ...
 */
class CollegeTSTool extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tools';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSToolFiles()
    {
        return $this->hasMany(\App\Models\CollegeTSToolFile::class);
    }
