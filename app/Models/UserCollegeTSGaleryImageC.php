...
/**
 * Class UserCollegeTSGaleryImageC
 * @package App\Models
 * @version June 18, 2018, 8:55 pm UTC
 *
 * @property \App\Models\UserCollegeTSGaleryImage userCollegeTSGaleryImage
 ...
 * @property integer user_c_t_s_g_i_id
 */
class UserCollegeTSGaleryImageC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_galery_image_c';
     ...
     **/
    public function userCollegeTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSGaleryImage::class);
    }
