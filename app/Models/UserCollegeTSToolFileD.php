...
/**
 * Class UserCollegeTSToolFileD
 * @package App\Models
 * @version June 18, 2018, 9:08 pm UTC
 *
 * @property \App\Models\UserCollegeTSToolFile userCollegeTSToolFile
 ...
 * @property integer user_c_t_s_t_f_id
 */
class UserCollegeTSToolFileD extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_tool_file_d';
     ...
     **/
    public function userCollegeTSToolFile()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSToolFile::class);
    }
