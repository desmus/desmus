...
/**
 * Class ProjectTSPlaylist
 * @package App\Models
 * @version June 29, 2018, 7:07 pm UTC
 *
 * @property \App\Models\ProjectTopicSection projectTopicSection
 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSPlaylistCreate
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSPlaylistDelete
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSPlaylistUpdate
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSPlaylistView
 ...
 * @property integer p_t_s_id
 */
class ProjectTSPlaylist extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_playlists';
     ...
     **/
    public function projectTopicSection()
    {
        return $this->belongsTo(\App\Models\ProjectTopicSection::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSPlaylistCreates()
    {
        return $this->hasMany(\App\Models\ProjectTSPlaylistCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSPlaylistDeletes()
    {
        return $this->hasMany(\App\Models\ProjectTSPlaylistDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSPlaylistUpdates()
    {
        return $this->hasMany(\App\Models\ProjectTSPlaylistUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSPlaylistViews()
    {
        return $this->hasMany(\App\Models\ProjectTSPlaylistView::class);
    }
}
