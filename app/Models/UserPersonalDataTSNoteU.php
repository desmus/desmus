...
/**
 * Class UserPersonalDataTSNoteU
 * @package App\Models
 * @version June 18, 2018, 9:00 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSNote userPersonalDataTSNote
 ...
 */
class UserPersonalDataTSNoteU extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_note_u';
     ...
     **/
    public function userPersonalDataTSNote()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSNote::class);
    }
