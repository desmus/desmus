...
/**
 * Class CollegeTSGaleryImageUpdate
 * @package App\Models
 * @version May 5, 2018, 10:52 pm UTC
 *
 * @property \App\Models\CollegeTSGaleryImage collegeTSGaleryImage
 ...
 * @property integer college_t_s_g_image_id
 */
class CollegeTSGaleryImageUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_galery_image_updates';
    ...
    protected $casts = [
        ...
        'past_name' => 'string',
        'user_id' => 'integer',
        'college_t_s_g_image_id' => 'integer'
    ];
     ...
     **/
    public function collegeTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\CollegeTSGaleryImage::class);
    }
