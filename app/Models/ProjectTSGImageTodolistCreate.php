...
/**
 * Class ProjectTSGImageTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\JobTSGImageTodolist jobTSGImageTodolist
 ...
 * @property integer j_t_s_g_i_t_id
 */
class ProjectTSGImageTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_g_image_todolist_creates';
     ...
     **/
    public function jobTSGImageTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSGImageTodolist::class);
    }
