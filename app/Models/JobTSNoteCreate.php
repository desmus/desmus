...
/**
 * Class JobTSNoteCreate
 * @package App\Models
 * @version May 5, 2018, 10:48 pm UTC
 *
 * @property \App\Models\JobTSNote jobTSNote
 ...
 * @property integer job_t_s_note_id
 */
class JobTSNoteCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_note_creates';
     ...
     **/
    public function jobTSNote()
    {
        return $this->belongsTo(\App\Models\JobTSNote::class);
    }
