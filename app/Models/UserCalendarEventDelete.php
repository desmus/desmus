...
/**
 * Class UserCalendarEventDelete
 * @package App\Models
 * @version January 23, 2019, 7:32 pm UTC
 *
 * @property \App\Models\UserCalendarEvent userCalendarEvent
 ...
 * @property integer user_c_e_id
 */
class UserCalendarEventDelete extends Model
{
    use SoftDeletes;

    public $table = 'user_calendar_event_deletes';
     ...
     **/
    public function userCalendarEvent()
    {
        return $this->belongsTo(\App\Models\UserCalendarEvent::class);
    }
