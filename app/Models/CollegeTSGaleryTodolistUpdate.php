...
/**
 * Class CollegeTSGaleryTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:14 am UTC
 *
 * @property \App\Models\CollegeTSGaleryTodolist collegeTSGaleryTodolist
 ...
 * @property integer c_t_s_g_t_id
 */
class CollegeTSGaleryTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_galery_todolist_updates';
     ...
     **/
    public function collegeTSGaleryTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSGaleryTodolist::class);
    }
