...
/**
 * Class UserPersonalDataTopicSectionU
 * @package App\Models
 * @version June 18, 2018, 8:59 pm UTC
 *
 * @property \App\Models\UserPersonalDataTopicSection userPersonalDataTopicSection
 ...
 */
class UserPersonalDataTopicSectionU extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_topic_section_u';
     ...
     **/
    public function userPersonalDataTopicSection()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTopicSection::class);
    }
