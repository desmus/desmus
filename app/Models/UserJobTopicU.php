 ...
 * @property \App\Models\UserJobTopic userJobTopic
 ...
 * @property integer user_j_t_id
 */
class UserJobTopicU extends Model
{
    use SoftDeletes;

    public $table = 'user_job_topic_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTopic()
    {
        return $this->belongsTo(\App\Models\UserJobTopic::class);
    }
}
