...
/**
 * Class PublicVideoComment
 * @package App\Models
 * @version January 9, 2019, 11:10 pm UTC
 *
 * @property \App\Models\PublicVideo publicVideo
 ...
 * @property integer public_video_id
 * @property integer user_id
 */
class PublicVideoComment extends Model
{
    use SoftDeletes;

    public $table = 'public_video_comment';
    ...
    {
        return $this->belongsTo(\App\Models\PublicVideo::class);
    }
     ...
     **/
    public function publicVideoCommentResponses()
    {
        return $this->hasMany(\App\Models\PublicVideoCommentResponse::class);
    }
}
