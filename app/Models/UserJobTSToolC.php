...
/**
 * Class UserJobTSToolC
 * @package App\Models
 * @version June 18, 2018, 8:55 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSTool userJobTSTool
 ...
 * @property integer user_j_t_s_t_id
 */
class UserJobTSToolC extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_tool_c';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSTool()
    {
        return $this->belongsTo(\App\Models\UserJobTSTool::class);
    }
}
