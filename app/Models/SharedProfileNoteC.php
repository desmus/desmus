...
/**
 * Class SharedProfileNoteC
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileNote sharedProfileNote
 ...
 * @property integer s_p_n_id
 * @property integer user_id
 */
class SharedProfileNoteC extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_note_c';
     ...
     **/
    public function sharedProfileNote()
    {
        return $this->belongsTo(\App\Models\SharedProfileNote::class);
    }
     ...
     **/
    public function sharedProfileNoteCResponses()
    {
        return $this->hasMany(\App\Models\SharedProfileNoteCResponse::class);
    }
}
