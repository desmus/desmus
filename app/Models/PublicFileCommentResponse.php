...
/**
 * Class PublicFileCommentResponse
 * @package App\Models
 * @version December 19, 2018, 5:22 pm UTC
 *
 * @property \App\Models\PublicFileComment publicFileComment
 ...
 * @property integer public_file_comment_id
 * @property integer user_id
 */
class PublicFileCommentResponse extends Model
{
    use SoftDeletes;

    public $table = 'public_file_comment_response';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_file_comment_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicFileComment()
    {
        return $this->belongsTo(\App\Models\PublicFileComment::class);
    }
