...
/**
 * Class JobTSToolTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:09 am UTC
 *
 * @property \App\Models\JobTSToolTodolist jobTSToolTodolist
 ...
 * @property integer j_t_s_t_t_id
 */
class JobTSToolTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_tool_todolist_creates';
     ...
     **/
    public function jobTSToolTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSToolTodolist::class);
    }
