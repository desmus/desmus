...
/**
 * Class ProjectTSPTodolist
 * @package App\Models
 * @version July 2, 2018, 3:35 am UTC
 *
 * @property \App\Models\ProjectTSPlaylist projectTSPlaylist
 ...
 * @property integer p_t_s_p_id
 */
class ProjectTSPTodolist extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_p_todolists';
     ...
     **/
    public function projectTSPlaylist()
    {
        return $this->belongsTo(\App\Models\ProjectTSPlaylist::class);
    }
