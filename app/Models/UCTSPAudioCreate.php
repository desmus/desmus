...
/**
 * Class UCTSPAudioCreate
 * @package App\Models
 * @version July 2, 2018, 7:40 pm UTC
 *
 * @property \App\Models\UserCollegeTSPAudio userCollegeTSPAudio
 ...
 * @property integer u_c_t_s_p_a_id
 */
class UCTSPAudioCreate extends Model
{
    use SoftDeletes;

    public $table = 'u_c_t_s_p_audio_creates';
     ...
     **/
    public function userCollegeTSPAudio()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSPAudio::class);
    }
