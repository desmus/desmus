 ...
 * @property integer college_t_s_t_id
 */
class CollegeTSToolFile extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_files';
