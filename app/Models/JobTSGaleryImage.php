...
/**
 * Class JobTSGaleryImage
 * @package App\Models
 * @version May 5, 2018, 10:46 pm UTC
 *
 * @property \App\Models\JobTSGalery jobTSGalery
 ...
 * @property integer job_t_s_g_id
 */
class JobTSGaleryImage extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_galery_images';
     ...
     **/
    public function jobTSGalery()
    {
        return $this->belongsTo(\App\Models\JobTSGalery::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\JobTSGaleryImageDeletes::class);
    }
