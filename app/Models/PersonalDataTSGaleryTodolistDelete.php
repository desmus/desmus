...
/**
 * Class PersonalDataTSGaleryTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\PersonalDataTSGTodolist personalDataTSGTodolist
 ...
 * @property integer p_d_t_s_g_t_id
 */
class PersonalDataTSGaleryTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_g_todolist_deletes';
     ...
     **/
    public function personalDataTSGTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSGTodolist::class);
    }
