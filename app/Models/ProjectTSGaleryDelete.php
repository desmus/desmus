...
/**
 * Class ProjectTSGaleryDelete
 * @package App\Models
 * @version May 5, 2018, 10:55 pm UTC
 *
 * @property \App\Models\ProjectTSGalery projectTSGalery
 ...
 * @property integer project_t_s_galery_id
 */
class ProjectTSGaleryDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_galery_deletes';
     ...
     **/
    public function projectTSGalery()
    {
        return $this->belongsTo(\App\Models\ProjectTSGalery::class);
    }
