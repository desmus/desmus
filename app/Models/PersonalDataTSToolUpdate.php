...
/**
 * Class PersonalDataTSToolUpdate
 * @package App\Models
 * @version May 5, 2018, 10:51 pm UTC
 *
 * @property \App\Models\PersonalDataTSTool personalDataTSTool
 ...
 * @property integer personal_data_t_s_tool_id
 */
class PersonalDataTSToolUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_tool_updates';
    ...
    protected $casts = [
        ...
        'past_name' => 'string',
        'user_id' => 'integer',
        'personal_data_t_s_tool_id' => 'integer'
    ];
     ...
     **/
    public function personalDataTSTool()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSTool::class);
    }
