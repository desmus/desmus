...
/**
 * Class CollegeTSFileCreate
 * @package App\Models
 * @version May 5, 2018, 10:48 pm UTC
 *
 * @property \App\Models\CollegeTSFile collegeTSFile
 ...
 * @property integer college_t_s_file_id
 */
class CollegeTSFileCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_file_creates';
     ...
     **/
    public function collegeTSFile()
    {
        return $this->belongsTo(\App\Models\CollegeTSFile::class);
    }
