...
/**
 * Class CollegeTSPTodolist
 * @package App\Models
 * @version July 2, 2018, 3:34 am UTC
 *
 * @property \App\Models\CollegeTSPlaylist collegeTSPlaylist
 ...
 * @property integer c_t_s_p_id
 */
class CollegeTSPTodolist extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_p_todolists';
     ...
     **/
    public function collegeTSPlaylist()
    {
        return $this->belongsTo(\App\Models\CollegeTSPlaylist::class);
    }
