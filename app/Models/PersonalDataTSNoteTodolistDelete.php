...
/**
 * Class PersonalDataTSNoteTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\PersonalDataTSNTodolist personalDataTSNTodolist
 ...
 * @property integer p_d_t_s_n_t_id
 */
class PersonalDataTSNoteTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_n_todolist_deletes';
     ...
     **/
    public function personalDataTSNTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSNTodolist::class);
    }
