...
/**
 * Class UserJobTSNoteC
 * @package App\Models
 * @version June 18, 2018, 8:54 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSNote userJobTSNote
 ...
 * @property integer user_j_t_s_n_id
 */
class UserJobTSNoteC extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_note_c';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSNote()
    {
        return $this->belongsTo(\App\Models\UserJobTSNote::class);
    }
}
