...
/**
 * Class PersonalDataTSGaleryImageDelete
 * @package App\Models
 * @version May 5, 2018, 10:56 pm UTC
 *
 * @property \App\Models\PersonalDataTSGaleryImage personalDataTSGaleryImage
 ...
 * @property integer p_d_t_s_g_i_id
 */
class PersonalDataTSGaleryImageDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_galery_image_deletes';
     ...
     **/
    public function personalDataTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSGaleryImage::class);
    }
