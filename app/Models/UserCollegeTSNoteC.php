...
/**
 * Class UserCollegeTSNoteC
 * @package App\Models
 * @version June 18, 2018, 8:54 pm UTC
 *
 * @property \App\Models\UserCollegeTSNote userCollegeTSNote
 ...
 * @property integer user_c_t_s_n_id
 */
class UserCollegeTSNoteC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_note_c';
     ...
     **/
    public function userCollegeTSNote()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSNote::class);
    }
