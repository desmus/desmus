...
/**
 * Class JobTopicSectionTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\JobTopicSectionTodolist jobTopicSectionTodolist
 ...
 * @property integer j_t_s_t_id
 */
class JobTopicSectionTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_topic_section_todolist_deletes';
     ...
     **/
    public function jobTopicSectionTodolist()
    {
        return $this->belongsTo(\App\Models\JobTopicSectionTodolist::class);
    }
