...
/**
 * Class UserPersonalDataU
 * @package App\Models
 * @version June 18, 2018, 8:59 pm UTC
 *
 * @property \App\Models\UserPersonalData userPersonalData
 ...
 */
class UserPersonalDataU extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_u';
    ...
    {
        return $this->belongsTo(\App\Models\UserPersonalData::class);
    }
