...
/**
 * Class UserCollegeTopicSectionD
 * @package App\Models
 * @version June 18, 2018, 9:03 pm UTC
 *
 * @property \App\Models\UserCollegeTopicSection userCollegeTopicSection
 ...
 */
class UserCollegeTopicSectionD extends Model
{
    use SoftDeletes;

    public $table = 'user_college_topic_section_d';
     ...
     **/
    public function userCollegeTopicSection()
    {
        return $this->belongsTo(\App\Models\UserCollegeTopicSection::class);
    }
