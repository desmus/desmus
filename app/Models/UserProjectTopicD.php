...
/**
 * Class UserProjectTopicD
 * @package App\Models
 * @version June 18, 2018, 9:03 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTopic userProjectTopic
 ...
 * @property integer user_p_t_id
 */
class UserProjectTopicD extends Model
{
    use SoftDeletes;

    public $table = 'user_project_topic_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTopic()
    {
        return $this->belongsTo(\App\Models\UserProjectTopic::class);
    }
}
