 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSGaleryImage
 ...
 * @property integer project_topic_section_id
 */
class ProjectTSGalerie extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_galeries';
    ...
    protected $casts = [
        ...
        'status' => 'string',
        'project_topic_section_id' => 'integer'
    ];
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSGaleryImages()
    {
        return $this->hasMany(\App\Models\ProjectTSGaleryImage::class);
    }
