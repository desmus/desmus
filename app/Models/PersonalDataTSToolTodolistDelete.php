...
/**
 * Class PersonalDataTSToolTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\PersonalDataTSTTodolist personalDataTSTTodolist
 ...
 * @property integer p_d_t_s_t_t_id
 */
class PersonalDataTSToolTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_t_todolist_deletes';
     ...
     **/
    public function personalDataTSTTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSTTodolist::class);
    }
