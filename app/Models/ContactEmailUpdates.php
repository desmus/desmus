...
/**
 * Class ContactEmailUpdates
 * @package App\Models
 * @version July 9, 2018, 9:21 pm UTC
 *
 * @property \App\Models\ContactEmail contactEmail
 ...
 * @property integer contact_email_id
 */
class ContactEmailUpdates extends Model
{
    use SoftDeletes;

    public $table = 'contact_email_updates';
    ...
    {
        return $this->belongsTo(\App\Models\ContactEmail::class);
    }
