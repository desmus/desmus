...
/**
 * Class UserPersonalDataTSGalerie
 * @package App\Models
 * @version May 5, 2018, 10:47 pm UTC
 *
 * @property \App\Models\PersonalDataTSGalery personalDataTSGalery
 ...
 * @property integer personal_data_t_s_g_id
 */
class UserPersonalDataTSGalerie extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_galeries';
    ...
    protected $casts = [
        ...
        'permissions' => 'string',
        'user_id' => 'integer',
        'personal_data_t_s_g_id' => 'integer'
    ];
     ...
     **/
    public function personalDataTSGalery()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSGalery::class);
    }
