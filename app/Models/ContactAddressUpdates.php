...
/**
 * Class ContactAddressUpdates
 * @package App\Models
 * @version July 9, 2018, 9:48 pm UTC
 *
 * @property \App\Models\ContactAddress contactAddress
 ...
 */
class ContactAddressUpdates extends Model
{
    use SoftDeletes;

    public $table = 'contact_address_updates';
    ...
    {
        return $this->belongsTo(\App\Models\ContactAddress::class);
    }
