...
/**
 * Class SharedProfileNoteCResponse
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileNoteC sharedProfileNoteC
 ...
 * @property integer s_p_n_c_id
 * @property integer user_id
 */
class SharedProfileNoteCResponse extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_note_c_response';
     ...
     **/
    public function sharedProfileNoteC()
    {
        return $this->belongsTo(\App\Models\SharedProfileNoteC::class);
    }
