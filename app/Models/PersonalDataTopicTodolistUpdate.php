...
/**
 * Class PersonalDataTopicTodolistUpdate
 * @package App\Models
 ...
 * @property integer p_d_t_t_id
 */
class PersonalDataTopicTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_topic_todolist_updates';
