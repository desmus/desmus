...
/**
 * Class CollegeTSNoteCreate
 * @package App\Models
 * @version May 5, 2018, 10:48 pm UTC
 *
 * @property \App\Models\CollegeTSNote collegeTSNote
 ...
 * @property integer college_t_s_note_id
 */
class CollegeTSNoteCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_note_creates';
     ...
     **/
    public function collegeTSNote()
    {
        return $this->belongsTo(\App\Models\CollegeTSNote::class);
    }
