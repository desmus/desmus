...
/**
 * Class JobTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\JobTodolist jobTodolist
 ...
 * @property integer j_t_id
 */
class JobTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_todolist_deletes';
     ...
     **/
    public function jobTodolist()
    {
        return $this->belongsTo(\App\Models\JobTodolist::class);
    }
