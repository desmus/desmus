...
/**
 * Class CollegeTSToolFileCreate
 * @package App\Models
 * @version May 5, 2018, 10:49 pm UTC
 *
 * @property \App\Models\CollegeTSToolFile collegeTSToolFile
 ...
 * @property integer college_t_s_t_file_id
 */
class CollegeTSToolFileCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_file_creates';
     ...
     **/
    public function collegeTSToolFile()
    {
        return $this->belongsTo(\App\Models\CollegeTSToolFile::class);
    }
