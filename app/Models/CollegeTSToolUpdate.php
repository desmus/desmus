...
/**
 * Class CollegeTSToolUpdate
 * @package App\Models
 * @version May 5, 2018, 10:51 pm UTC
 *
 * @property \App\Models\CollegeTSTool collegeTSTool
 ...
 * @property integer college_t_s_tool_id
 */
class CollegeTSToolUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_updates';
     ...
     **/
    public function collegeTSTool()
    {
        return $this->belongsTo(\App\Models\CollegeTSTool::class);
    }
