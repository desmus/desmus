...
/**
 * Class UserCollegeTSToolU
 * @package App\Models
 * @version June 18, 2018, 9:01 pm UTC
 *
 * @property \App\Models\UserCollegeTSTool userCollegeTSTool
 ...
 * @property integer user_c_t_s_t_id
 */
class UserCollegeTSToolU extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_tool_u';
     ...
     **/
    public function userCollegeTSTool()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSTool::class);
    }
