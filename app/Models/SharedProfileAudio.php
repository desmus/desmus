 ...
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileAudioUpdate
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileAudioView
 ...
 */
class SharedProfileAudio extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_audio';
     ...
     **/
    public function sharedProfileAudioCs()
    {
        return $this->hasMany(\App\Models\SharedProfileAudioC::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileAudioLikes()
    {
        return $this->hasMany(\App\Models\SharedProfileAudioLike::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileAudioUpdates()
    {
        return $this->hasMany(\App\Models\SharedProfileAudioUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileAudioViews()
    {
        return $this->hasMany(\App\Models\SharedProfileAudioView::class);
    }
}
