...
/**
 * Class UserPersonalDataTSGaleryImageD
 * @package App\Models
 * @version June 18, 2018, 9:08 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSGaleryImage userPersonalDataTSGaleryImage
 ...
 */
class UserPersonalDataTSGaleryImageD extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_galery_image_d';
     ...
     **/
    public function userPersonalDataTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSGaleryImage::class);
    }
