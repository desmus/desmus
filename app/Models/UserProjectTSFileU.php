...
/**
 * Class UserProjectTSFileU
 * @package App\Models
 * @version November 8, 2018, 6:17 am UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSFile userProjectTSFile
 ...
 * @property integer user_p_t_s_f_id
 */
class UserProjectTSFileU extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_file_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSFile()
    {
        return $this->belongsTo(\App\Models\UserProjectTSFile::class);
    }
}
