...
class PublicImage extends Model
{
     ...
     **/
    public function publicImageComments()
    {
        return $this->hasMany(\App\Models\PublicImageComment::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function publicImageLikes()
    {
        return $this->hasMany(\App\Models\PublicImageLike::class);
    }
}
