...
/**
 * Class UserProjectTSToolU
 * @package App\Models
 * @version June 18, 2018, 9:01 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTSTool userProjectTSTool
 ...
 * @property integer user_p_t_s_t_id
 */
class UserProjectTSToolU extends Model
{
    use SoftDeletes;

    public $table = 'user_project_t_s_tool_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTSTool()
    {
        return $this->belongsTo(\App\Models\UserProjectTSTool::class);
    }
}
