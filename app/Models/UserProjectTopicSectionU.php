...
/**
 * Class UserProjectTopicSectionU
 * @package App\Models
 * @version June 18, 2018, 8:59 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserProjectTopicSection userProjectTopicSection
 ...
 * @property integer user_p_t_s_id
 */
class UserProjectTopicSectionU extends Model
{
    use SoftDeletes;

    public $table = 'user_project_topic_section_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userProjectTopicSection()
    {
        return $this->belongsTo(\App\Models\UserProjectTopicSection::class);
    }
}
