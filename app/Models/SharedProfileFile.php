 ...
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileFileUpdate
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileFileView
 ...
 */
class SharedProfileFile extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_file';
     ...
     **/
    public function sharedProfileFileCs()
    {
        return $this->hasMany(\App\Models\SharedProfileFileC::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileFileLikes()
    {
        return $this->hasMany(\App\Models\SharedProfileFileLike::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileFileUpdates()
    {
        return $this->hasMany(\App\Models\SharedProfileFileUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileFileViews()
    {
        return $this->hasMany(\App\Models\SharedProfileFileView::class);
    }
}
