 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTopicSection
...
class ProjectTopic extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTopicSections()
    {
        return $this->hasMany(\App\Models\ProjectTopicSection::class);
    }
