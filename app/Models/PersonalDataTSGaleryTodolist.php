...
/**
 * Class PersonalDataTSGaleryTodolist
 * @package App\Models
 ...
 * @property integer p_d_t_s_g_id
 */
class PersonalDataTSGaleryTodolist extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_g_todolists';
