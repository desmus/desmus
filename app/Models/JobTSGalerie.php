 ...
 * @property \Illuminate\Database\Eloquent\Collection JobTSGaleryImage
 ...
 * @property integer job_topic_section_id
 */
class JobTSGalerie extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_galeries';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function jobTSGaleryImages()
    {
        return $this->hasMany(\App\Models\JobTSGaleryImage::class);
    }
