...
/**
 * Class UserCollegeTSGalerieC
 * @package App\Models
 * @version June 18, 2018, 8:54 pm UTC
 *
 * @property \App\Models\UserCollegeTSGalery userCollegeTSGalery
 ...
 * @property integer user_c_t_s_g_id
 */
class UserCollegeTSGalerieC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_t_s_galerie_c';
     ...
     **/
    public function userCollegeTSGalery()
    {
        return $this->belongsTo(\App\Models\UserCollegeTSGalery::class);
    }
