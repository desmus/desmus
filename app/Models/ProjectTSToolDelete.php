...
/**
 * Class ProjectTSToolDelete
 * @package App\Models
 * @version May 5, 2018, 10:55 pm UTC
 *
 * @property \App\Models\ProjectTSTool projectTSTool
 ...
 * @property integer project_t_s_tool_id
 */
class ProjectTSToolDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_deletes';
     ...
     **/
    public function projectTSTool()
    {
        return $this->belongsTo(\App\Models\ProjectTSTool::class);
    }
