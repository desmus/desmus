 ...
 * @property integer j_t_s_g_i_id
 */
class JobTSGImageTodolist extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_g_image_todolists';
