...
/**
 * Class PersonalDataTSPTodolist
 * @package App\Models
 * @version July 2, 2018, 3:36 am UTC
 *
 * @property \App\Models\PersonalDataTSPlaylist personalDataTSPlaylist
 ...
 * @property integer p_d_t_s_p_id
 */
class PersonalDataTSPTodolist extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_p_todolists';
     ...
     **/
    public function personalDataTSPlaylist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSPlaylist::class);
    }
