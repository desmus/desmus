...
/**
 * Class UPTSPAudioUpdate
 * @package App\Models
 * @version July 2, 2018, 7:41 pm UTC
 *
 * @property \App\Models\UserProjectTSPAudio userProjectTSPAudio
 ...
 * @property integer u_p_t_s_p_a_id
 */
class UPTSPAudioUpdate extends Model
{
    use SoftDeletes;

    public $table = 'u_p_t_s_p_audio_updates';
     ...
     **/
    public function userProjectTSPAudio()
    {
        return $this->belongsTo(\App\Models\UserProjectTSPAudio::class);
    }
