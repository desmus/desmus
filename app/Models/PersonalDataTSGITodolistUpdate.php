...
/**
 * Class PersonalDataTSGITodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\PersonalDataTSGITodolist personalDataTSGITodolist
 ...
 * @property integer p_d_t_s_g_i_t_id
 */
class PersonalDataTSGITodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_g_i_todolist_updates';
     ...
     **/
    public function personalDataTSGITodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSGITodolist::class);
    }
