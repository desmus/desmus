...
/**
 * Class CollegeTSToolFileTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\CollegeTSToolFileTodolist collegeTSToolFileTodolist
 ...
 * @property integer c_t_s_t_f_t_id
 */
class CollegeTSToolFileTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_tool_file_todolist_updates';
     ...
     **/
    public function collegeTSToolFileTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSToolFileTodolist::class);
    }
