...
/**
 * Class JobTSNoteTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:08 am UTC
 *
 * @property \App\Models\JobTSNoteTodolist jobTSNoteTodolist
 ...
 * @property integer j_t_s_n_t_id
 */
class JobTSNoteTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_note_todolist_creates';
     ...
     **/
    public function jobTSNoteTodolist()
    {
        return $this->belongsTo(\App\Models\JobTSNoteTodolist::class);
    }
