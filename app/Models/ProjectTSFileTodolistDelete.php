...
/**
 * Class ProjectTSFileTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\ProjectTSFileTodolist projectTSFileTodolist
 ...
 * @property integer p_t_s_f_t_id
 */
class ProjectTSFileTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_file_todolist_deletes';
     ...
     **/
    public function projectTSFileTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSFileTodolist::class);
    }
