...
/**
 * Class ProjectTSNoteCreate
 * @package App\Models
 * @version May 5, 2018, 10:48 pm UTC
 *
 * @property \App\Models\ProjectTSNote projectTSNote
 ...
 * @property integer project_t_s_note_id
 */
class ProjectTSNoteCreate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_note_creates';
     ...
     **/
    public function projectTSNote()
    {
        return $this->belongsTo(\App\Models\ProjectTSNote::class);
    }
