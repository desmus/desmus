...
/**
 * Class ProjectTSPAudioDelete
 * @package App\Models
 * @version July 1, 2018, 6:58 am UTC
 *
 * @property \App\Models\ProjectTSPAudio projectTSPAudio
 ...
 * @property integer p_t_s_p_a_id
 */
class ProjectTSPAudioDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_p_audio_deletes';
     ...
     **/
    public function projectTSPAudio()
    {
        return $this->belongsTo(\App\Models\ProjectTSPAudio::class);
    }
