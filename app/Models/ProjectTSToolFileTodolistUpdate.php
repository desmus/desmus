...
/**
 * Class ProjectTSToolFileTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\ProjectTSToolFileTodolist projectTSToolFileTodolist
 ...
 * @property integer p_t_s_t_f_t_id
 */
class ProjectTSToolFileTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_file_todolist_updates';
     ...
     **/
    public function projectTSToolFileTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSToolFileTodolist::class);
    }
