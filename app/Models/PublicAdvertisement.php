 ...
 */
class PublicAdvertisement extends Model
{
    use SoftDeletes;

    public $table = 'public_advertisement';
     ...
     **/
    public function publicAdvertisementComments()
    {
        return $this->hasMany(\App\Models\PublicAdvertisementComment::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function publicAdvertisementLikes()
    {
        return $this->hasMany(\App\Models\PublicAdvertisementLike::class);
    }
}
