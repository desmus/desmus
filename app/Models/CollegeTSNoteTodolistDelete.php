...
/**
 * Class CollegeTSNoteTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\CollegeTSNoteTodolist collegeTSNoteTodolist
 ...
 * @property integer c_t_s_n_t_id
 */
class CollegeTSNoteTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_note_todolist_deletes';
     ...
     **/
    public function collegeTSNoteTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSNoteTodolist::class);
    }
