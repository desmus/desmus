...
/**
 * Class SharedProfileVideoCResponse
 * @package App\Models
 * @version April 11, 2019, 3:29 pm UTC
 *
 * @property \App\Models\SharedProfileVideoC sharedProfileVideoC
 ...
 * @property integer s_p_v_c_id
 * @property integer user_id
 */
class SharedProfileVideoCResponse extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_video_c_response';
     ...
     **/
    public function sharedProfileVideoC()
    {
        return $this->belongsTo(\App\Models\SharedProfileVideoC::class);
    }
