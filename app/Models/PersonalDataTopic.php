...
/**
 * Class PersonalDataTopic
 * @package App\Models
 * @version May 5, 2018, 10:45 pm UTC
 *
 * @property \App\Models\PersonalData personalData
 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTopicSection
 ...
 */
class PersonalDataTopic extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_topics';
    ...
    {
        return $this->belongsTo(\App\Models\PersonalData::class);
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTopicSections()
    {
        return $this->hasMany(\App\Models\PersonalDataTopicSection::class);
    }
