 ...
 * @property \Illuminate\Database\Eloquent\Collection CollegeTSGaleryImage
 ...
 * @property integer college_topic_section_id
 */
class CollegeTSGalerie extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_galeries';
    ...
    protected $casts = [
        ...
        'status' => 'string',
        'college_topic_section_id' => 'integer'
    ];
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function collegeTSGaleryImages()
    {
        return $this->hasMany(\App\Models\CollegeTSGaleryImage::class);
    }
