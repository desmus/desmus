 ...
 * @property integer job_t_s_galery_id
 */
class JobTSGaleryDelete extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_galery_deletes';
