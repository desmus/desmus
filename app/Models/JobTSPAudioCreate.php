...
/**
 * Class JobTSPAudioCreate
 * @package App\Models
 * @version July 1, 2018, 6:57 am UTC
 *
 * @property \App\Models\JobTSPAudio jobTSPAudio
 ...
 * @property integer j_t_s_p_a_id
 */
class JobTSPAudioCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_p_audio_creates';
     ...
     **/
    public function jobTSPAudio()
    {
        return $this->belongsTo(\App\Models\JobTSPAudio::class);
    }
