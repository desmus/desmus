...
/**
 * Class SharedProfileAudioCResponse
 * @package App\Models
 * @version April 11, 2019, 3:28 pm UTC
 *
 * @property \App\Models\SharedProfileAudioC sharedProfileAudioC
 ...
 * @property integer s_p_a_c_id
 * @property integer user_id
 */
class SharedProfileAudioCResponse extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_audio_c_response';
     ...
     **/
    public function sharedProfileAudioC()
    {
        return $this->belongsTo(\App\Models\SharedProfileAudioC::class);
    }
