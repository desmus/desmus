...
/**
 * Class ProjectTSToolFileTodolist
 * @package App\Models
 ...
 * @property integer p_t_s_t_f_id
 */
class ProjectTSToolFileTodolist extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tool_file_todolists';
