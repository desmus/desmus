...
/**
 * Class UserJobTSGalerieU
 * @package App\Models
 * @version June 18, 2018, 9:00 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSGalery userJobTSGalery
 ...
 * @property integer user_j_t_s_g_id
 */
class UserJobTSGalerieU extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_galerie_u';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSGalery()
    {
        return $this->belongsTo(\App\Models\UserJobTSGalery::class);
    }
}
