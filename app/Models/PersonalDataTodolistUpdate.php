...
/**
 * Class PersonalDataTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:13 am UTC
 *
 * @property \App\Models\PersonalDataTodolist personalDataTodolist
 ...
 */
class PersonalDataTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_todolist_updates';
     ...
     **/
    public function personalDataTodolist()
    {
        return $this->belongsTo(\App\Models\PersonalDataTodolist::class);
    }
