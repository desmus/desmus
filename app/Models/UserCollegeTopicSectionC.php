...
/**
 * Class UserCollegeTopicSectionC
 * @package App\Models
 ...
 * @property integer user_c_t_s_id
 */
class UserCollegeTopicSectionC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_topic_section_c';
