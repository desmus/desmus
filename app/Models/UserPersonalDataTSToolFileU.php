...
/**
 * Class UserPersonalDataTSToolFileU
 * @package App\Models
 * @version June 18, 2018, 9:02 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSToolFile userPersonalDataTSToolFile
 ...
 */
class UserPersonalDataTSToolFileU extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_tool_file_u';
     ...
     **/
    public function userPersonalDataTSToolFile()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSToolFile::class);
    }
