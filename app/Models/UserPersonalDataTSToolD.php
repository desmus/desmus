...
/**
 * Class UserPersonalDataTSToolD
 * @package App\Models
 * @version June 18, 2018, 9:07 pm UTC
 *
 * @property \App\Models\UserPersonalDataTSTool userPersonalDataTSTool
 ...
 */
class UserPersonalDataTSToolD extends Model
{
    use SoftDeletes;

    public $table = 'user_personal_data_t_s_tool_d';
     ...
     **/
    public function userPersonalDataTSTool()
    {
        return $this->belongsTo(\App\Models\UserPersonalDataTSTool::class);
    }
