 ...
 *
 * @property \App\Models\UserCollege userCollege
 ...
 * @property integer user_c_id
 */
class UserCollegeC extends Model
{
    use SoftDeletes;

    public $table = 'user_college_c';
    ...
    {
        return $this->belongsTo(\App\Models\UserCollege::class);
    }
