...
/**
 * Class ProjectTSGaleryTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:16 am UTC
 *
 * @property \App\Models\ProjectTSGaleryTodolist projectTSGaleryTodolist
 ...
 * @property integer p_t_s_g_t_id
 */
class ProjectTSGaleryTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_galery_todolist_deletes';
     ...
     **/
    public function projectTSGaleryTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTSGaleryTodolist::class);
    }
