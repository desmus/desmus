...
/**
 * Class JobTSToolFileCreate
 * @package App\Models
 * @version May 5, 2018, 10:49 pm UTC
 *
 * @property \App\Models\JobTSToolFile jobTSToolFile
 ...
 * @property integer job_t_s_t_file_id
 */
class JobTSToolFileCreate extends Model
{
    use SoftDeletes;

    public $table = 'job_t_s_tool_file_creates';
     ...
     **/
    public function jobTSToolFile()
    {
        return $this->belongsTo(\App\Models\JobTSToolFile::class);
    }
