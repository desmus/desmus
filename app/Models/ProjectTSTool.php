 ...
 * @property \Illuminate\Database\Eloquent\Collection ProjectTSToolFile
 ...
 */
class ProjectTSTool extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_tools';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectTSToolFiles()
    {
        return $this->hasMany(\App\Models\ProjectTSToolFile::class);
    }
