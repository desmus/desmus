 ...
 * @property \Illuminate\Database\Eloquent\Collection UserSharedProfileCreate
 * @property \Illuminate\Database\Eloquent\Collection UserSharedProfileDelete
 * @property \Illuminate\Database\Eloquent\Collection UserSharedProfileUpdate
 * @property string|\Carbon\Carbon datetime
 * @property string description
 * @property string status
 * @property string permissions
 * @property integer shared_user_id
 * @property integer user_id
 */
class UserSharedProfile extends Model
{
    use SoftDeletes;

    public $table = 'user_shared_profile';
     ...
     **/
    public function userSharedProfileCreates()
    {
        return $this->hasMany(\App\Models\UserSharedProfileCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function userSharedProfileDeletes()
    {
        return $this->hasMany(\App\Models\UserSharedProfileDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function userSharedProfileUpdates()
    {
        return $this->hasMany(\App\Models\UserSharedProfileUpdate::class);
    }
}
