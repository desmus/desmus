 ...
 * @property integer project_t_s_g_id
 */
class ProjectTSGaleryImage extends Model
{
    use SoftDeletes;

    public $table = 'project_t_s_galery_images';
