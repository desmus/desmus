...
/**
 * Class ContactWebDeletes
 * @package App\Models
 * @version July 9, 2018, 9:45 pm UTC
 *
 * @property \App\Models\ContactWeb contactWeb
 ...
 * @property integer contact_web_id
 */
class ContactWebDeletes extends Model
{
    use SoftDeletes;

    public $table = 'contact_web_deletes';
    ...
    {
        return $this->belongsTo(\App\Models\ContactWeb::class);
    }
