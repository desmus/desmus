...
/**
 * Class ContactTelephoneDeletes
 * @package App\Models
 * @version July 9, 2018, 9:20 pm UTC
 *
 * @property \App\Models\ContactTelephone contactTelephone
 ...
 * @property integer contact_telephone_id
 */
class ContactTelephoneDeletes extends Model
{
    use SoftDeletes;

    public $table = 'contact_telephone_deletes';
     ...
     **/
    public function contactTelephone()
    {
        return $this->belongsTo(\App\Models\ContactTelephone::class);
    }
