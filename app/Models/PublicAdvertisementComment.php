...
/**
 * Class PublicAdvertisementComment
 * @package App\Models
 * @version December 19, 2018, 5:24 pm UTC
 *
 * @property \App\Models\PublicAdvertisement publicAdvertisement
 ...
 * @property integer public_advertisement_id
 * @property integer user_id
 */
class PublicAdvertisementComment extends Model
{
    use SoftDeletes;

    public $table = 'public_advertisement_comment';
    ...
    protected $casts = [
        ...
        'content' => 'string',
        'status' => 'string',
        'public_advertisement_id' => 'integer',
        'user_id' => 'integer'
    ];
     ...
     **/
    public function publicAdvertisement()
    {
        return $this->belongsTo(\App\Models\PublicAdvertisement::class);
    }
     ...
     **/
    public function publicAdvertisementCResponses()
    {
        return $this->hasMany(\App\Models\PublicAdvertisementCResponse::class);
    }
}
