...
/**
 * Class CollegeTSFileTodolistCreate
 * @package App\Models
 * @version May 30, 2018, 3:08 am UTC
 *
 * @property \App\Models\CollegeTSFileTodolist collegeTSFileTodolist
 ...
 * @property integer c_t_s_f_t_id
 */
class CollegeTSFileTodolistCreate extends Model
{
    use SoftDeletes;

    public $table = 'college_t_s_file_todolist_creates';
     ...
     **/
    public function collegeTSFileTodolist()
    {
        return $this->belongsTo(\App\Models\CollegeTSFileTodolist::class);
    }
