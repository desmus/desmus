...
/**
 * Class PersonalDataTSToolFileView
 * @package App\Models
 * @version May 5, 2018, 10:50 pm UTC
 *
 * @property \App\Models\PersonalDataTSToolFile personalDataTSToolFile
 ...
 * @property integer personal_d_t_s_t_f_id
 */
class PersonalDataTSToolFileView extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_tool_file_views';
     ...
     **/
    public function personalDataTSToolFile()
    {
        return $this->belongsTo(\App\Models\PersonalDataTSToolFile::class);
    }
