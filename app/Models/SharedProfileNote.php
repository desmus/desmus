 ...
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileNoteUpdate
 * @property \Illuminate\Database\Eloquent\Collection SharedProfileNoteView
 ...
 */
class SharedProfileNote extends Model
{
    use SoftDeletes;

    public $table = 'shared_profile_note';
     ...
     **/
    public function sharedProfileNoteCs()
    {
        return $this->hasMany(\App\Models\SharedProfileNoteC::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileNoteLikes()
    {
        return $this->hasMany(\App\Models\SharedProfileNoteLike::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileNoteUpdates()
    {
        return $this->hasMany(\App\Models\SharedProfileNoteUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function sharedProfileNoteViews()
    {
        return $this->hasMany(\App\Models\SharedProfileNoteView::class);
    }
}
