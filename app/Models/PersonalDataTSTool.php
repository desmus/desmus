 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSToolFile
 ...
 * @property integer personal_data_topic_section_id
 */
class PersonalDataTSTool extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_tools';
    ...
    protected $casts = [
        ...
        'status' => 'string',
        'personal_data_topic_section_id' => 'integer'
    ];
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSToolFiles()
    {
        return $this->hasMany(\App\Models\PersonalDataTSToolFile::class);
    }
