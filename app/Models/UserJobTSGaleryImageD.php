...
/**
 * Class UserJobTSGaleryImageD
 * @package App\Models
 * @version June 18, 2018, 9:07 pm UTC
 *
 * @property \App\Models\User user
 * @property \App\Models\UserJobTSGaleryImage userJobTSGaleryImage
 ...
 * @property integer user_j_t_s_g_i_id
 */
class UserJobTSGaleryImageD extends Model
{
    use SoftDeletes;

    public $table = 'user_job_t_s_galery_image_d';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function userJobTSGaleryImage()
    {
        return $this->belongsTo(\App\Models\UserJobTSGaleryImage::class);
    }
}
