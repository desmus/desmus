...
/**
 * Class PersonalDataTSPlaylist
 * @package App\Models
 * @version June 29, 2018, 7:07 pm UTC
 *
 * @property \App\Models\PersonalDataTopicSection personalDataTopicSection
 ...
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSPCreate
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSPDelete
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSPUpdate
 * @property \Illuminate\Database\Eloquent\Collection PersonalDataTSPView
 ...
 * @property integer p_d_t_s_id
 */
class PersonalDataTSPlaylist extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_t_s_playlists';
     ...
     **/
    public function personalDataTopicSection()
    {
        return $this->belongsTo(\App\Models\PersonalDataTopicSection::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSPCreates()
    {
        return $this->hasMany(\App\Models\PersonalDataTSPCreate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSPDeletes()
    {
        return $this->hasMany(\App\Models\PersonalDataTSPDelete::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSPUpdates()
    {
        return $this->hasMany(\App\Models\PersonalDataTSPUpdate::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function personalDataTSPViews()
    {
        return $this->hasMany(\App\Models\PersonalDataTSPView::class);
    }
}
