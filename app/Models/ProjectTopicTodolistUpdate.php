...
/**
 * Class ProjectTopicTodolistUpdate
 * @package App\Models
 * @version May 30, 2018, 3:13 am UTC
 *
 * @property \App\Models\ProjectTopicTodolist projectTopicTodolist
 ...
 * @property integer p_t_t_id
 */
class ProjectTopicTodolistUpdate extends Model
{
    use SoftDeletes;

    public $table = 'project_topic_todolist_updates';
     ...
     **/
    public function projectTopicTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTopicTodolist::class);
    }
