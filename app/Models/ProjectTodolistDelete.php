...
/**
 * Class ProjectTodolistDelete
 * @package App\Models
 * @version May 30, 2018, 3:15 am UTC
 *
 * @property \App\Models\ProjectTodolist projectTodolist
 ...
 */
class ProjectTodolistDelete extends Model
{
    use SoftDeletes;

    public $table = 'project_todolist_deletes';
     ...
     **/
    public function projectTodolist()
    {
        return $this->belongsTo(\App\Models\ProjectTodolist::class);
    }
