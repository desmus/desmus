...
class PublicProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        if(isset(Auth::user()->id))
        {
            ...
            $files = DB::table('public_file')->where('user_id', $user_id)->where(function ($query) {$query->where('public_file.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'file_p');
            $notes = DB::table('public_note')->where('user_id', $user_id)->where(function ($query) {$query->where('public_note.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'note_p');
            $images = DB::table('public_image')->where('user_id', $user_id)->where(function ($query) {$query->where('public_image.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'image_p');
            $audios = DB::table('public_audio')->where('user_id', $user_id)->where(function ($query) {$query->where('public_audio.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'audio_p');
            $videos = DB::table('public_video')->where('user_id', $user_id)->where(function ($query) {$query->where('public_video.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'video_p');
            $advertisements = DB::table('public_advertisement')->where('user_id', $user_id)->where(function ($query) {$query->where('public_advertisement.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(50, ['*'], 'advertising_p');
        ...
        $files_list = DB::table('public_file')->where(function ($query) {$query->where('public_file.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        $notes_list = DB::table('public_note')->where(function ($query) {$query->where('public_note.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        $images_list = DB::table('public_image')->where(function ($query) {$query->where('public_image.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        $audios_list = DB::table('public_audio')->where(function ($query) {$query->where('public_audio.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        $videos_list = DB::table('public_video')->where(function ($query) {$query->where('public_video.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        $advertisements_list = DB::table('public_advertisement')->where(function ($query) {$query->where('public_advertisement.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
