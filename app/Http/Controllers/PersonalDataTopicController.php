    ...
    public function show($id, Request $request)
    {
        if(Auth::user() != null)
        {
            ...
            if($user_id == $user[0] -> id || $isShared)
            {
                ...
                $personalDataTopicTodolist = DB::table('personal_datas')->join('personal_data_topics', 'personal_datas.id', '=', 'personal_data_topics.personal_data_id')->join('personal_data_topic_todolists', 'personal_data_topics.id', '=', 'personal_data_topic_todolists.p_d_t_id')->where('personal_data_topic_todolists.p_d_t_id', '=', $personalDataTopic -> id)->where(function ($query) {$query->where('personal_data_topic_todolists.deleted_at', '=', null);})->where(function ($query) {$query->where('personal_data_topic_todolists.status', '=', 'active');})->orderBy('personal_data_topic_todolists.datetime', 'desc')->limit(50)->get();
                $personalDataTopicTodolistCompleted = DB::table('personal_datas')->join('personal_data_topics', 'personal_datas.id', '=', 'personal_data_topics.personal_data_id')->join('personal_data_topic_todolists', 'personal_data_topics.id', '=', 'personal_data_topic_todolists.p_d_t_id')->where('personal_data_topic_todolists.p_d_t_id', '=', $personalDataTopic -> id)->where(function ($query) {$query->where('personal_data_topic_todolists.status', '=', 'finalized');})->where(function ($query) {$query->where('personal_data_topic_todolists.deleted_at', '=', null);})->orderBy('personal_data_topic_todolists.datetime', 'desc')->limit(50)->get();
                ...
                $personalDataTopicTodolistsList = DB::table('personal_datas')->join('personal_data_topics', 'personal_datas.id', '=', 'personal_data_topics.personal_data_id')->join('personal_data_topic_todolists', 'personal_data_topics.id', '=', 'personal_data_topic_todolists.p_d_t_id')->where('personal_data_topic_todolists.p_d_t_id', '=', $personalDataTopic -> id)->where(function ($query) {$query->where('personal_data_topic_todolists.deleted_at', '=', null);})->where(function ($query) {$query->where('personal_data_topic_todolists.status', '=', 'active');})->orderBy('personal_data_topic_todolists.datetime', 'desc')->limit(5)->get();
                $personalDataTopicTodolistsCompletedList = DB::table('personal_datas')->join('personal_data_topics', 'personal_datas.id', '=', 'personal_data_topics.personal_data_id')->join('personal_data_topic_todolists', 'personal_data_topics.id', '=', 'personal_data_topic_todolists.p_d_t_id')->where('personal_data_topic_todolists.p_d_t_id', '=', $personalDataTopic -> id)->where(function ($query) {$query->where('personal_data_topic_todolists.status', '=', 'finalized');})->where(function ($query) {$query->where('personal_data_topic_todolists.deleted_at', '=', null);})->orderBy('personal_data_topic_todolists.datetime', 'desc')->limit(5)->get();
