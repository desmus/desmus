...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_t_s_file_create').on('submit', function() {
      
      var user_college_t_s_file_description = document.getElementById("description").value;
      var user_college_t_s_file_user_id = document.getElementById("user_id").value;
      
      if(user_college_t_s_file_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_college_t_s_file_description == '' || user_college_t_s_file_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userCollegeTSFiles.store', 'id' => 'user_college_t_s_file_create']) !!}

            @include('user_college_t_s_files.create_fields')
