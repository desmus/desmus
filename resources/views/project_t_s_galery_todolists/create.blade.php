...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_galery_todolist_create').on('submit', function() {
      ...
      var project_t_s_galery_todolist_status = document.getElementById("status").value;
      var project_t_s_galery_todolist_datetime = document.getElementById("datetime").value;
      
      var date_format = /^(\d{4})-(\d{1,2})-(\d{1,2})$/;
      
      if(project_t_s_galery_todolist_name.length >= 100)
      {
        alert("Invalid character number for the task name.");
        return false;
      }
      
      if(project_t_s_galery_todolist_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
  
      if(project_t_s_galery_todolist_datetime != '')
      {
        if(date_formats = project_t_s_galery_todolist_datetime.match(date_format))
        {
      ...
      if(project_t_s_galery_todolist_name == '' || project_t_s_galery_todolist_description == '' || project_t_s_galery_todolist_status == '' || project_t_s_galery_todolist_datetime == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Project Topic Section Galery Todolist </h1>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'projectTSGaleryTodolists.store', 'id' => 'project_t_s_galery_todolist_create']) !!}
            ...
            @include('project_t_s_galery_todolists.fields')
