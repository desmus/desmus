        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTSGaleryTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTSGaleryTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $projectTSGaleryTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $projectTSGaleryTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTSGaleryTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTSGaleryTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTSGaleryTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSGaleryTodolistViews as $projectTSGaleryTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSGaleryTodolistView->name !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistView->email !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSGaleryTodolistUpdates as $projectTSGaleryTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSGaleryTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistUpdate->name !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistUpdate->email !!} </td>
                                <td class=""> {!! $projectTSGaleryTodolistUpdate->datetime !!} </td>
