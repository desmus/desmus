{!! Form::open(['route' => 'projectTodolists.store', 'id' => 'project_todolist_create']) !!}
    ...
    <div class="col-md-12">
      ...
      <div class="nav-tabs-custom" style="margin-bottom: 0;">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class = "active"><a href="#project_topic" data-toggle="tab"> Topics </a></li>
          <li><a href="#project_info" data-toggle="tab"> Information </a></li>
          <li><a href="#project_specific_info" data-toggle="tab"> Specific Information </a></li>
          <li><a href="#project_tasks" data-toggle="tab"> Tasks </a></li>
          <li><a href="#project_statistics" data-toggle="tab"> Statistics </a></li>
          <li><a href="#project_most_viewed" data-toggle="tab"> Most Viewed </a></li>
          <li><a href="#project_views_history" data-toggle="tab"> Views History </a></li>
          <li><a href="#project_updates_history" data-toggle="tab"> Updates History </a></li>

        </ul>

        <div class="tab-content clearfix">

          <div class = "tab-pane active" id = "project_topic">

            @include('project_topics.filtered_table')
              ...
              <div class="pull-right">
                ...
                <div class="btn-group">
                  ...
                  @if($project_topic_p < 1)
                    ...
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p=1" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p=2" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
                  ...
                  @if($project_topic_p == 1)
                    ...
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p=1" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p={!! $project_topic_p + 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>

                  @endif
                        
                  @if($project_topic_p > 1)
                        
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p={!! $project_topic_p - 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                    <a href = "http://desmus-jmsp.c9users.io/projects/{!! $id !!}?project_topic_p={!! $project_topic_p + 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
          ...
          <div class = "tab-pane" id = "project_specific_info">

            <div id="toolbar-container"></div>

            {!! Form::model($project, ['route' => ['projects.update', $project->id], 'method' => 'patch']) !!}

              <div class = "form-group" id="editor"> {!! $project->specific_info !!} </div>
            ...
            <div class="box box-primary" style="position: relative; left: 0px; top: 0px;">
              ...
              <div class="box-body">
                ...
                <ul class="todo-list ui-sortable">
                  ...
                  @foreach($projectTodolist as $task)
                  
                    <a href = "{!! route('projectTodolists.show', [$task->id]) !!}">
                      ...
                      <li>
                        ...
                        <div class="tools">
                          ...
                          {!! Form::open(['route' => ['projectTodolists.destroy', $task->id], 'method' => 'delete']) !!}
                          
                            <a class='btn btn-default btn-xs' href = "{!! route('projectTodolists.edit', [$task->id]) !!}"> <i class="fa fa-edit"></i> </a>
            ...
            <div class="box box-primary" style="position: relative; left: 0px; top: 0px; margin-bottom: 10px;">
              ...
              <div class="box-body">
                ...
                <ul class="todo-list ui-sortable">
                  ...
                  @foreach($projectTodolistCompleted as $task)
          ...
          <div class = "tab-pane" id = "project_statistics">
            ...
            <div class="col-lg-4 col-xs-4">
              ...
              <div class="small-box bg-yellow" style="margin-bottom: 0;">
                ...
                <div class="inner">
                  ...
                  <h3><sup style="font-size: 20px">{!! $projectTopicCount !!}</sup></h3>
                ...
                <a href = "#project_topic" data-toggle="tab" class="small-box-footer">
            ...
            <div class="col-lg-4 col-xs-4">
              ...
              <div class="small-box bg-green" style="margin-bottom: 0;">
                ...
                <div class="inner">
                  ...
                  <h3><sup style="font-size: 20px">{!! $project -> views_quantity !!}</sup></h3>
                ...
                <a href = "#project_views_history" data-toggle="tab" class="small-box-footer">
            ...
            <div class="col-lg-4 col-xs-4">
              ...
              <div class="small-box bg-red" style="margin-bottom: 0;">
                ...
                <div class="inner">
                  ...
                  <h3><sup style="font-size: 20px">{!! $project -> updates_quantity !!}</sup></h3>
                ...
                <a href = "#project_updates_history" data-toggle="tab" class="small-box-footer">
          ...
          <div class = "tab-pane" id = "project_most_viewed">
            ...
            <div class="box box-primary col-sm-6">
              ...
              <div class="box-body">
                ...
                <ul class="products-list product-list-in-box">
                  ...
                  @foreach($projectTopicList as $topic)
                
                    <li class="item">
                  
                      <div class="product-info">
                    
                        <a href="{!! route('projectTopics.show', [$topic -> id]) !!}" class="product-title">       
                          <span class="label label-warning pull-right">{!! $topic -> views_quantity !!}</span>
                        </a>
                
                        <a href = "{!! route('projectTopics.show', [$topic -> id]) !!}">
          ...
          <div class = "tab-pane" id = "project_views_history">
                          ...
                          <tbody>
                            ...
                            @foreach($projectViews as $projectView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectView->name !!} </td>
                                <td class=""> {!! $projectView->email !!} </td>
                                <td class=""> {!! $projectView->datetime !!} </td>
          ...
          <div class = "tab-pane" id = "project_updates_history">
                          ...
                          <tbody>
                            ...
                            @foreach($projectUpdates as $projectUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectUpdate->past_name !!} </td>
                                <td class=""> {!! $projectUpdate->name !!} </td>
                                <td class=""> {!! $projectUpdate->email !!} </td>
                                <td class="sorting_1"> {!! $projectUpdate->datetime !!} </td>
