...
{!! Form::hidden('project_t_s_g_id', 'Project T S G Id:') !!}
{!! Form::hidden('project_t_s_g_id', $id, ['class' => 'form-control']) !!}

<div class="form-group col-sm-12" style="margin-bottom: 0;">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('projectTSGaleries.show', [$id]) !!}" class="btn btn-default">Cancel</a>
</div>