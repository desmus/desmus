...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_g_image_update').on('submit', function() {
      ...
      if(project_t_s_g_image_name == '' || project_t_s_g_image_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($projectTSGaleryImage, ['route' => ['projectTSGaleryImages.update', $projectTSGaleryImage->id], 'method' => 'patch',  'id' => 'project_t_s_g_image_update']) !!}
            
            @include('project_t_s_galery_images.fields')
