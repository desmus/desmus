...
@section('scripts')
  ...
  <script>
    ...
    $('#college_topic_todolist_create').on('submit', function() {
      ...
      if(college_topic_todolist_datetime != '')
      {
        if(date_formats = college_topic_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + college_topic_todolist_datetime);
          return false;
        }
      }
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'collegeTopicTodolists.store', 'id' => 'college_topic_todolist_create']) !!}
            ...
            @include('collegeTopic_topic_todolists.fields')
