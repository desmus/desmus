        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTopicTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTopicTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTopicTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTopicTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTopicTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTopicTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTopicTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTopicTodolistViews as $personalDataTopicTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTopicTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTopicTodolistUpdates as $personalDataTopicTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTopicTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTopicTodolistUpdate->datetime !!} </td>
