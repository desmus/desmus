...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_topic_todolist_create').on('submit', function() {
      ...
      if(personal_data_topic_todolist_datetime != '')
      {
        if(date_formats = personal_data_topic_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + personal_data_topic_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Personal Data Topic Todolist </h1>
