        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
              ...
              <p>{!! $personalDataTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
              {!! Form::label('description', 'Description:') !!}
              <p>{!! $personalDataTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
              {!! Form::label('datetime', 'Datetime:') !!}
              <p>{!! $personalDataTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
              {!! Form::label('created_at', 'Created At:') !!}
              <p>{!! $personalDataTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
              {!! Form::label('updated_at', 'Updated At:') !!}
              <p>{!! $personalDataTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTodolistViews as $personalDataTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTodolistUpdates as $personalDataTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTodolistUpdate->datetime !!} </td>
