...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_todolist_create').on('submit', function() {
      ...
      if(personal_data_todolist_datetime != '')
      {
        if(date_formats = personal_data_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + personal_data_todolist_datetime);
          return false;
        }
      }
