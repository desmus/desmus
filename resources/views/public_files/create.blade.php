...
@section('scripts')
  ...
  <script>
    ...
    $('#public_file_create').on('submit', function() {
      
      var public_file_name = document.getElementById("name").value;
      var public_file_description = document.getElementById("description").value;
      var public_file_file = document.getElementById("file").value;
      
      if(public_file_name.length >= 100)
      {
        alert("Invalid character number for the file name.");
        return false;
      }
      
      if(public_file_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(public_file_name == '' || public_file_description == '' || public_file_file == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <form id = 'public_file_create' action = "{!! URL::to('/store_public_file') !!}" enctype = "multipart/form-data" method = "post">
            
            {{ csrf_field() }}

            @include('public_files.create_fields')
