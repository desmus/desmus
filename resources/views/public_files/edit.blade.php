...
@section('scripts')
  ...
  <script>
    ...
    $('#public_file_update').on('submit', function() {
      ...
      if(public_file_name == '' || public_file_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($publicFile, ['route' => ['publicFiles.update', $publicFile->id], 'method' => 'patch', 'id' => 'public_file_update']) !!}

            @include('public_files.fields')
