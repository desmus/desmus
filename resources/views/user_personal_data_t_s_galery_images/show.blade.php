...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $personalDataTSGaleryImage[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_personal_data_t_s_galery_images.show_fields')
          <a href="{!! route('personalDataTSGaleries.show', [$personalDataTSGaleryImage[0] -> personal_data_t_s_g_id]) !!}" class="btn btn-default">Back</a>
