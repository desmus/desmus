...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_topic_update').on('submit', function() {
      
      var user_personal_data_topic_permissions = document.getElementById("permissions").value;
      
      if(user_personal_data_topic_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userPersonalDataTopic[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userPersonalDataTopic, ['route' => ['userPersonalDataTopics.update', $userPersonalDataTopic[0]->id], 'method' => 'patch', 'id' => 'user_personal_data_topic_update']) !!}

            @include('user_personal_data_topics.fields')
