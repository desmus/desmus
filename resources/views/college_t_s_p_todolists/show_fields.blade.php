        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $collegeTSPTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $collegeTSPTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $collegeTSPTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $collegeTSPTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $collegeTSPTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTSPTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTSPTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTSPTViews as $collegeTSPTView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTSPTView->name !!} </td>
                                <td class=""> {!! $collegeTSPTView->email !!} </td>
                                <td class=""> {!! $collegeTSPTView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTSPTUpdates as $collegeTSPTUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTSPTUpdate->actual_name !!} </td>
                                <td class=""> {!! $collegeTSPTUpdate->past_name !!} </td>
                                <td class=""> {!! $collegeTSPTUpdate->name !!} </td>
                                <td class=""> {!! $collegeTSPTUpdate->email !!} </td>
                                <td class=""> {!! $collegeTSPTUpdate->datetime !!} </td>
