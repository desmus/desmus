...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_p_todolist_create').on('submit', function() {
      ...
      if(college_t_s_p_todolist_datetime != '')
      {
        if(date_formats = college_t_s_p_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + college_t_s_p_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> College Topic Section Playlist Todolist </h1>
