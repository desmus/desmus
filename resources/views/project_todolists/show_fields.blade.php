        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $projectTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $projectTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTodolistViews as $projectTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTodolistView->name !!} </td>
                                <td class=""> {!! $projectTodolistView->email !!} </td>
                                <td class=""> {!! $projectTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTodolistUpdates as $projectTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTodolistUpdate->name !!} </td>
                                <td class=""> {!! $projectTodolistUpdate->email !!} </td>
                                <td class=""> {!! $projectTodolistUpdate->datetime !!} </td>
