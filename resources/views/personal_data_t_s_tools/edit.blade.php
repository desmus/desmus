...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_t_s_tool_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($personalDataTSTool, ['route' => ['personalDataTSTools.update', $personalDataTSTool->id], 'method' => 'patch',  'id' => 'personal_data_t_s_tool_update']) !!}

            @include('personal_data_t_s_tools.fields')
