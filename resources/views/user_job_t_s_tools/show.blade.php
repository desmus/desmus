...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $jobTSTool[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_job_t_s_tools.show_fields')
          <a href="{!! route('jobTopicSections.show', [$jobTSTool[0] -> job_topic_section_id]) !!}" class="btn btn-default">Back</a>
