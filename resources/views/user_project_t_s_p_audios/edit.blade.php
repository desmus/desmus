...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_p_audio_update').on('submit', function() {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSPAudio[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSPAudio, ['route' => ['userProjectTSPAudios.update', $userProjectTSPAudio[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_p_audio_update']) !!}

            @include('user_project_t_s_p_audios.fields')
