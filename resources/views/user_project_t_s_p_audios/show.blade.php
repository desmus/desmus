...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $projectTSPAudio[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_project_t_s_p_audios.show_fields')
          <a href="{!! route('projectTSPAudios.show', [$projectTSPAudio[0] -> id]) !!}" class="btn btn-default">Back</a>
