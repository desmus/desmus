...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_file_update').on('submit', function() {
      ...
      if(shared_profile_file_name == '' || shared_profile_file_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($sharedProfileFile, ['route' => ['sharedProfileFiles.update', $sharedProfileFile->id], 'method' => 'patch', 'id' => 'shared_profile_file_update']) !!}

            @include('shared_profile_files.fields')
