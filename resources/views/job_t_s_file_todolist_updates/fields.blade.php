...
<div class="form-group col-sm-6">
  {!! Form::label('j_t_s_f_t_id', 'C T S F T Id:') !!}
  {!! Form::number('j_t_s_f_t_id', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-12">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('jobTSFileTodolistUpdates.index') !!}" class="btn btn-default">Cancel</a>
</div>