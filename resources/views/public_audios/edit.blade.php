...
@section('scripts')
  ...
  <script>
    ...
    $('#public_audio_update').on('submit', function() {
      ...
      if(public_audio_name == '' || public_audio_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($publicAudio, ['route' => ['publicAudios.update', $publicAudio->id], 'method' => 'patch', 'id' => 'public_audio_update']) !!}
          
            @include('public_audios.fields')
