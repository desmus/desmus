...
@section('scripts')
  ...
  <script>
    ...
    $('#public_note_update').on('submit', function() {
      
      var public_note_name = document.getElementById("name").value;
      var public_note_description = document.getElementById("description").value;
      
      if(public_note_name.length >= 100)
      {
        alert("Invalid character number for the note name.");
        return false;
      }
      
      if(public_note_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(public_note_name == '' || public_note_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($publicNote, ['route' => ['publicNotes.update', $publicNote->id], 'method' => 'patch',  'id' => 'public_note_update']) !!}

            @include('public_notes.fields')
