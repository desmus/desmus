...
@section('scripts')
  ...
  <script>
    ...
    $('#user_job_update').on('submit', function() {
      
      var user_job_permissions = document.getElementById("permissions").value;
      
      if(user_job_permissions == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userJob, ['route' => ['userJobs.update', $userJob[0]->id], 'method' => 'patch', 'id' => 'user_job_update']) !!}

            @include('user_jobs.fields')
