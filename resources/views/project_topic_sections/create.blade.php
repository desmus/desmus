...
@section('scripts')
  ...
  <script>
    ...
    $('#project_topic_section_create').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'projectTopicSections.store', 'id' => 'project_topic_section_create']) !!}

            @include('project_topic_sections.create_fields')
