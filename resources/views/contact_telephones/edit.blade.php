...
@section('scripts')
  ...
  <script>
    ...
    $('#contact_telephone_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($contactTelephone, ['route' => ['contactTelephones.update', $contactTelephone->id], 'method' => 'patch', 'id' => 'contact_telephone_update']) !!}
          
            @include('contact_telephones.fields')
