...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTSGaleryImage[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_t_s_galery_images.show_fields')
          <a href="{!! route('collegeTSGaleries.show', [$collegeTSGaleryImage[0] -> college_t_s_g_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
