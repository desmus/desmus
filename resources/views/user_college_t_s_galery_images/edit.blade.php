...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_t_s_g_image_update').on('submit', function() {
      
      var user_college_t_s_g_image_permissions = document.getElementById("description").value;
      
      if(user_college_t_s_g_image_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userCollegeTSGaleryImage[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userCollegeTSGaleryImage, ['route' => ['userCollegeTSGaleryImages.update', $userCollegeTSGaleryImage[0]->id], 'method' => 'patch', 'id' => 'user_college_t_s_g_image_update']) !!}

            @include('user_college_t_s_galery_images.fields')
