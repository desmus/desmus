    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('personal_data_t_s_files.show_fields')
          
          <a href="{!! route('personalDataTopicSections.show', [$personalDataTSFile -> personal_data_t_s_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
