...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTSToolFile[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_t_s_tool_files.show_fields')
          <a href="{!! route('collegeTSTools.show', [$collegeTSToolFile[0] -> college_t_s_t_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
