...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_file_update').on('submit', function() {
      
      var user_project_t_s_file_permissions = document.getElementById("description").value;
      
      if(user_project_t_s_file_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSFile[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSFile, ['route' => ['userProjectTSFiles.update', $userProjectTSFile[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_file_update']) !!}

            @include('user_project_t_s_files.fields')
