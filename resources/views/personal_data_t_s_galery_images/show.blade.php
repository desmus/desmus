    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('personal_data_t_s_galery_images.show_fields')
          
          <a href="{!! route('personalDataTSGaleries.show', [$personalDataTSGaleryImage -> personal_data_t_s_g_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
