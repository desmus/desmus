...
{!! Form::hidden('personal_data_t_s_g_id', 'Job T S G Id:') !!}
{!! Form::hidden('personal_data_t_s_g_id', $id, ['class' => 'form-control']) !!}

<div class="form-group col-sm-12">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('personalDataTSGaleries.show', [$id]) !!}" class="btn btn-default">Cancel</a>
</div>