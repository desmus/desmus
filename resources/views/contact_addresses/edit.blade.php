...
@section('scripts')
  ...
  <script>
    ...
    $('#contact_address_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($contactAddress, ['route' => ['contactAddresses.update', $contactAddress->id], 'method' => 'patch', 'id' => 'contact_address_update']) !!}
          
            @include('contact_addresses.fields')
