...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_audio_update').on('submit', function() {
      ...
      if(shared_profile_audio_name == '' || shared_profile_audio_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($sharedProfileAudio, ['route' => ['sharedProfileAudios.update', $sharedProfileAudio->id], 'method' => 'patch', 'id' => 'shared_profile_audio_update']) !!}
          
            @include('shared_profile_audios.fields')
