...
@section('scripts')
  ...
  <script>
    ...
    $('#contact_web_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($contactWeb, ['route' => ['contactWebs.update', $contactWeb->id], 'method' => 'patch', 'id' => 'contact_web_update']) !!}
          
            @include('contact_webs.fields')
