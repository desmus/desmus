...
<div class="form-group col-sm-6">
  {!! Form::label('project_topic_id', 'College Topic Id:') !!}
  {!! Form::number('project_topic_id', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-12">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('projectTopicUpdates.index') !!}" class="btn btn-default">Cancel</a>
</div>