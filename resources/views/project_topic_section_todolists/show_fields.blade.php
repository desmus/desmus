        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTopicSectionTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTopicSectionTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $projectTopicSectionTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $projectTopicSectionTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTopicSectionTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTopicSectionTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTopicSectionTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTopicSectionTodolistViews as $projectTopicSectionTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTopicSectionTodolistView->name !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistView->email !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTopicSectionTodolistUpdates as $projectTopicSectionTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTopicSectionTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistUpdate->name !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistUpdate->email !!} </td>
                                <td class=""> {!! $projectTopicSectionTodolistUpdate->datetime !!} </td>
