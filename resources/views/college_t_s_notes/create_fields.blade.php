...
{!! Form::hidden('content', 'Write Here ...', ['class' => 'form-control']) !!}
...
{!! Form::hidden('college_topic_section_id', $id, ['class' => 'form-control']) !!}

<div class="form-group col-sm-12" style="margin-bottom: 0;">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('collegeTopicSections.show', [$id]) !!}" class="btn btn-default">Cancel</a>
</div>