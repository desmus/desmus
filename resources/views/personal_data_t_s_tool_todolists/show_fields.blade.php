        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTSToolTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTSToolTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTSToolTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTSToolTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTSToolTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSToolTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSToolTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSToolTodolistViews as $personalDataTSToolTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSToolTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSToolTodolistUpdates as $personalDataTSToolTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSToolTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTSToolTodolistUpdate->datetime !!} </td>
