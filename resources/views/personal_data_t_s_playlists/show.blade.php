...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_t_s_p_todolist_create').on('submit', function() {
      ...
      if(personal_data_t_s_p_todolist_name == '' || personal_data_t_s_p_todolist_description == '' || personal_data_t_s_p_todolist_datetime == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $personalDataTSPlaylist->name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('personal_data_t_s_playlists.show_fields')
          
          <a href="{!! route('personalDataTopicSections.show', [$personalDataTSPlaylist -> p_d_t_s_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
