{!! Form::open(['route' => 'projectTSGaleryTodolists.store', 'id' => 'project_t_s_galery_todolist_create']) !!}
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class = "row">
            ...
            {!! Form::hidden('p_t_s_g_id', 'Project Topic Section Id:') !!}
            {!! Form::hidden('p_t_s_g_id', $id, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-12">
      ...
      <div class="nav-tabs-custom" style="margin-bottom: 0;">
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="#project_topic_section_galery_info" data-toggle="tab"> Galery Information </a></li>
          <li class = "active"><a href="#project_topic_section_galery_preview" data-toggle="tab"> Galery Preview </a></li>
          <li><a href="#project_topic_section_galery_tasks" data-toggle="tab"> Tasks </a></li>
          <li><a href="#project_topic_section_galery_views_history" data-toggle="tab"> Views History </a></li>
          <li><a href="#project_topic_section_galery_updates_history" data-toggle="tab"> Updates History </a></li>
          
          @if($user[0] -> id == $user_id)
          
            <li><a href="{!! route('projectTSGaleryImages.create', [$projectTSGalerie->id]) !!}"> Add Image </a></li>
        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "project_topic_section_galery_preview">
            ...
            <div class="col-md-12" style="padding: 0;">
              ...
              <div class="widget-container" style="margin-bottom: 0;">
                ...
                <div class="widget row image-tile">
                  ...
                  @foreach($projectTSGaleryImages as $image)
            
                    @if($image -> deleted_at == null)
            
                      <a href = "{!! route('projectTSGaleryImages.show', [$image->id]) !!}">
                        
                        <div class="tile col-xs-4" style="background: url('/images/projects/image_{!! $image -> id !!}.{!! $image -> file_type !!}') no-repeat center top; background-size: cover;">
                          <p> </p>
                        </div>
          ...
          <div class = "tab-pane" id = "project_topic_section_galery_info">
            
            <div class="form-group">
                {!! Form::label('name', 'Name:') !!}
                <p>{!! $projectTSGalerie->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTSGalerie->description !!}</p>
            </div>
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTSGalerie->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTSGalerie->updated_at !!}</p>
            </div>

          </div>
          
          <div class = "tab-pane" id = "project_topic_section_galery_tasks">
            ...
            <div class="box box-primary" style="position: relative; left: 0px; top: 0px;">
              ...
              <div class="box-body">
                ...
                <ul class="todo-list ui-sortable">
                  ...
                  @foreach($projectTSGaleryTodolist as $task)
                  
                    <a href = "{!! route('projectTSGaleryTodolists.show', [$task->id]) !!}">
                      ...
                      <li>
                        ...
                        <div class="tools">
                          ...
                          {!! Form::open(['route' => ['projectTSGaleryTodolists.destroy', $task->id], 'method' => 'delete']) !!}
                          
                            <a class='btn btn-default btn-xs' href = "{!! route('projectTSGaleryTodolists.edit', [$task->id]) !!}"> <i class="fa fa-edit"></i> </a>
            ...
            <div class="box box-primary" style="position: relative; left: 0px; top: 0px; margin-bottom: 10px;">
              ...
              <div class="box-body">
                ...
                <ul class="todo-list ui-sortable">
                  ...
                  @foreach($projectTSGaleryTodolistCompleted as $task)
          ...
          <div class = "tab-pane" id = "project_topic_section_galery_views_history">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="small-box bg-green">
                        ...
                        <div class="inner">
                          ...
                          <h3><sup style="font-size: 20px">{!! $projectTSGalerie -> views_quantity !!}</sup></h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSGaleryViews as $projectTSGaleryView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSGaleryView->name !!} </td>
                                <td class=""> {!! $projectTSGaleryView->email !!} </td>
                                <td class=""> {!! $projectTSGaleryView->datetime !!} </td>
          ...
          <div class = "tab-pane" id = "project_topic_section_galery_updates_history">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="small-box bg-red">
                        ...
                        <div class="inner">
                          ...
                          <h3><sup style="font-size: 20px">{!! $projectTSGalerie -> updates_quantity !!}</sup></h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSGaleryUpdates as $projectTSGaleryUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSGaleryUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTSGaleryUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTSGaleryUpdate->name !!} </td>
                                <td class=""> {!! $projectTSGaleryUpdate->email !!} </td>
                                <td class="sorting_1"> {!! $projectTSGaleryUpdate->datetime !!} </td>
