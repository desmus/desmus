...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_galery_update').on('submit', function() {
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            {!! Form::model($projectTSGalerie, ['route' => ['projectTSGaleries.update', $projectTSGalerie->id], 'method' => 'patch', 'id' => 'project_t_s_galery_update']) !!}
            
              @include('project_t_s_galeries.fields')
