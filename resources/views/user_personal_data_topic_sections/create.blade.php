...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_topic_section_create').on('submit', function() {
      
      var user_personal_data_topic_section_description = document.getElementById("description").value;
      var user_personal_data_topic_section_user_id = document.getElementById("user_id").value;
      
      if(user_personal_data_topic_section_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_personal_data_topic_section_description == '' || user_personal_data_topic_section_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userPersonalDataTopicSections.store', 'id' => 'user_personal_data_topic_section_create']) !!}

            @include('user_personal_data_topic_sections.create_fields')
