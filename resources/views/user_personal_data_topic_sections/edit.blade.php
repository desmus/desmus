...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_topic_section_update').on('submit', function() {
      
      var user_personal_data_topic_section_permissions = document.getElementById("permissions").value;
      
      if(user_personal_data_topic_section_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userPersonalDataTopicSection[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userPersonalDataTopicSection, ['route' => ['userPersonalDataTopicSections.update', $userPersonalDataTopicSection[0]->id], 'method' => 'patch', 'id' => 'user_personal_data_topic_section_update']) !!}

            @include('user_personal_data_topic_sections.fields')
