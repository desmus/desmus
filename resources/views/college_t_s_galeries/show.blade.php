...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_galery_todolist_create').on('submit', function() {
      ...
      if(college_t_s_galery_todolist_name == '' || college_t_s_galery_todolist_description == '' || college_t_s_galery_todolist_datetime == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('college_t_s_galeries.show_fields')
                    
          <a href="{!! route('collegeTopicSections.show', [$collegeTSGalerie -> college_topic_section_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
