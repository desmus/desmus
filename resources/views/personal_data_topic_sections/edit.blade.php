...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_topic_section_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($personalDataTopicSection, ['route' => ['personalDataTopicSections.update', $personalDataTopicSection->id], 'method' => 'patch', 'id' => 'personal_data_topic_section_update']) !!}

            @include('personal_data_topic_sections.fields')
