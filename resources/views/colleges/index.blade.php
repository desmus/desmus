  ...
  <script type="text/javascript">
    ...
    $('#sectionSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTopicSectionSearch')}}',
        data:{'search':$value},
  ...
  <script type="text/javascript">
    ...
    $('#fileSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTSFileSearch')}}',
        data:{'search':$value},
  ...
  <script type="text/javascript">
    ...
    $('#noteSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTSNoteSearch')}}',
        data:{'search':$value},
  ...
  <script type="text/javascript">
    ...
    $('#galerySearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTSGalerySearch')}}',
        data:{'search':$value},
  ...
  <script type="text/javascript">
    ...
    $('#playlistSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTSPlaylistSearch')}}',
        data:{'search':$value},
  ...
  <script type="text/javascript">
    ...
    $value=$(this).val();
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('CollegeTSToolSearch')}}',
        data:{'search':$value},
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1 class="pull-left" style="margin-top: 5px;">Colleges</h1>
    <h1 class="pull-right" style="margin-top: 10px;"> <a class="btn btn-primary pull-right" style="margin-top: -10px; margin-bottom: 10px" href="{!! route('colleges.create') !!}">Add New</a> </h1>
                    ...
                    <div class="pull-right">
                      ...
                      <div class="btn-group">
                        ...
                        @if($college_p < 1)
                          ...
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p=1" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p=2" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
                        ...
                        @if($college_p == 1)
                          ...
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p=1" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p={!! $college_p + 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>

                        @endif
                        
                        @if($college_p > 1)
                        
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p={!! $college_p - 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i></a>
                          <a href = "http://desmus-jmsp.c9users.io/colleges?college_p={!! $college_p + 1 !!}" class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></a>
