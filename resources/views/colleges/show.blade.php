...
@section('scripts')
  ...
  <script>
    ...
    $('#college_todolist_create').on('submit', function() {
      ...
      if(college_todolist_name == '' || college_todolist_description == '' || college_todolist_datetime == '')
      {
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @if($user[0] -> id == $user_id)
            ...
            <a href="{!! route('collegeTopics.create', [$college -> id]) !!}" class="btn btn-default">Add Topic</a>
