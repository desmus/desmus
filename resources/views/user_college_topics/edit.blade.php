...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_topic_update').on('submit', function() {
      
      var user_college_topic_permissions = document.getElementById("permissions").value;
      
      if(user_college_topic_permissions == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userCollegeTopic, ['route' => ['userCollegeTopics.update', $userCollegeTopic[0]->id], 'method' => 'patch', 'id' => 'user_college_topic_update']) !!}

            @include('user_college_topics.fields')
