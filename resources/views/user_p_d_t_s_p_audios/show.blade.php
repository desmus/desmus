...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $personalDataTSPAudio[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_p_d_t_s_p_audios.show_fields')
          <a href="{!! route('personalDataTSPAudios.show', [$personalDataTSPAudio[0] -> id]) !!}" class="btn btn-default">Back</a>
