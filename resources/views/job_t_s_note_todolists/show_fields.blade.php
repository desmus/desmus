        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $jobTSNoteTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $jobTSNoteTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $jobTSNoteTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $jobTSNoteTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $jobTSNoteTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTSNoteTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTSNoteTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTSNoteTodolistViews as $jobTSNoteTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTSNoteTodolistView->name !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistView->email !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTSNoteTodolistUpdates as $jobTSNoteTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTSNoteTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistUpdate->name !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistUpdate->email !!} </td>
                                <td class=""> {!! $jobTSNoteTodolistUpdate->datetime !!} </td>
