...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_t_s_galery_update').on('submit', function() {
      
      var user_college_t_s_galery_permissions = document.getElementById("description").value;
      
      if(user_college_t_s_galery_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userCollegeTSGalerie[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userCollegeTSGalerie, ['route' => ['userCollegeTSGaleries.update', $userCollegeTSGalerie[0]->id], 'method' => 'patch', 'id' => 'user_college_t_s_galery_update']) !!}

            @include('user_college_t_s_galeries.fields')
