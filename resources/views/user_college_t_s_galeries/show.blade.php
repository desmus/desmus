...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTSGalerie[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_t_s_galeries.show_fields')
          <a href="{!! route('collegeTopicSections.show', [$collegeTSGalerie[0] -> college_topic_section_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
