...
<div class="form-group col-sm-6">
  {!! Form::label('p_d_t_s_n_t_id', 'P D T S N T Id:') !!}
  {!! Form::number('p_d_t_s_n_t_id', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-12">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('personalDataTSNoteTodolistUpdates.index') !!}" class="btn btn-default">Cancel</a>
</div>