...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_create').on('submit', function() {
      
      var user_personal_data_description = document.getElementById("description").value;
      var user_personal_data_user_id = document.getElementById("user_id").value;
      
      if(user_personal_data_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_personal_data_description == '' || user_personal_data_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userPersonalDatas.store', 'id' => 'user_personal_data_create']) !!}

            @include('user_personal_datas.create_fields')
