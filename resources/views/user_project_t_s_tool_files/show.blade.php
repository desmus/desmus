...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $projectTSToolFile[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_project_t_s_tool_files.show_fields')
          <a href="{!! route('projectTSTools.show', [$projectTSToolFile[0] -> project_t_s_t_id]) !!}" class="btn btn-default">Back</a>
