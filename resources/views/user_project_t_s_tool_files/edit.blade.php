...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_tool_file_update').on('submit', function() {
      
     var user_project_t_s_tool_file_permissions = document.getElementById("description").value;
      
      if(user_project_t_s_tool_file_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSToolFile[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSToolFile, ['route' => ['userProjectTSToolFiles.update', $userProjectTSToolFile[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_tool_file_update']) !!}

            @include('user_project_t_s_tool_files.fields')
