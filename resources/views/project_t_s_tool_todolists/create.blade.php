...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_tool_todolist_create').on('submit', function() {
      ...
      var project_t_s_tool_todolist_status = document.getElementById("status").value;
      var project_t_s_tool_todolist_datetime = document.getElementById("datetime").value;
      
      var date_format = /^(\d{4})-(\d{1,2})-(\d{1,2})$/;
      
      if(project_t_s_tool_todolist_name.length >= 100)
      {
        alert("Invalid character number for the task name.");
        return false;
      }
      
      if(project_t_s_tool_todolist_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
  
      if(project_t_s_tool_todolist_datetime != '')
      {
        if(date_formats = project_t_s_tool_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + project_t_s_tool_todolist_datetime);
          return false;
        }
      }
      
      if(project_t_s_tool_todolist_name == '' || project_t_s_tool_todolist_description == '' || project_t_s_tool_todolist_status == '' || project_t_s_tool_todolist_datetime == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Project Topic Section Tool Todolist </h1>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'projectTSToolTodolists.store', 'id' => 'project_t_s_tool_todolist_create']) !!}
            ...
            @include('project_t_s_tool_todolists.fields')
