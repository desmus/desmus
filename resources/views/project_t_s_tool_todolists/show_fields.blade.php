        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTSToolTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTSToolTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $projectTSToolTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $projectTSToolTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTSToolTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTSToolTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTSToolTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSToolTodolistViews as $projectTSToolTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSToolTodolistView->name !!} </td>
                                <td class=""> {!! $projectTSToolTodolistView->email !!} </td>
                                <td class=""> {!! $projectTSToolTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTSToolTodolistUpdates as $projectTSToolTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTSToolTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTSToolTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTSToolTodolistUpdate->name !!} </td>
                                <td class=""> {!! $projectTSToolTodolistUpdate->email !!} </td>
                                <td class=""> {!! $projectTSToolTodolistUpdate->datetime !!} </td>
