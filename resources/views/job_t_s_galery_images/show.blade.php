    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('job_t_s_galery_images.show_fields')
          <a href="{!! route('jobTSGaleries.show', [$jobTSGaleryImage -> job_t_s_g_id]) !!}" class="btn btn-default" style="margin-left: 20px">Back</a>
