        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTSNoteTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTSNoteTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTSNoteTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTSNoteTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTSNoteTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSNoteTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSNoteTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSNoteTodolistViews as $personalDataTSNoteTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSNoteTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSNoteTodolistUpdates as $personalDataTSNoteTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSNoteTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTSNoteTodolistUpdate->datetime !!} </td>
