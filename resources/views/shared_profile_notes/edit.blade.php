...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_note_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($sharedProfileNote, ['route' => ['sharedProfileNotes.update', $sharedProfileNote->id], 'method' => 'patch',  'id' => 'shared_profile_note_update']) !!}

            @include('shared_profile_notes.fields')
