...
@section('scripts')
  ...
  <script>
    ...
    $('#project_topic_todolist_create').on('submit', function() {
      ...
      if(project_topic_todolist_datetime != '')
      {
        if(date_formats = project_topic_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + project_topic_todolist_datetime);
          return false;
        }
      }
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'projectTopicTodolists.store', 'id' => 'project_topic_todolist_create']) !!}
            ...
            @include('projectTopic_topic_todolists.fields')
