        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $projectTopicTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $projectTopicTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $projectTopicTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $projectTopicTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $projectTopicTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTopicTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $projectTopicTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTopicTodolistViews as $projectTopicTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTopicTodolistView->name !!} </td>
                                <td class=""> {!! $projectTopicTodolistView->email !!} </td>
                                <td class=""> {!! $projectTopicTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($projectTopicTodolistUpdates as $projectTopicTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $projectTopicTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $projectTopicTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $projectTopicTodolistUpdate->name !!} </td>
                                <td class=""> {!! $projectTopicTodolistUpdate->email !!} </td>
                                <td class=""> {!! $projectTopicTodolistUpdate->datetime !!} </td>
