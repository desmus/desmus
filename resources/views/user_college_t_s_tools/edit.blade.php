...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_t_s_tool_update').on('submit', function() {
      
      var user_college_t_s_tool_permissions = document.getElementById("description").value;
      
      if(user_college_t_s_tool_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userCollegeTSTool[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userCollegeTSTool, ['route' => ['userCollegeTSTools.update', $userCollegeTSTool[0]->id], 'method' => 'patch', 'id' => 'user_college_t_s_tool_update']) !!}

            @include('user_college_t_s_tools.fields')
