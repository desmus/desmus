...
@section('scripts')
  ...
  <script>
    ...
    $('#job_topic_section_create').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'jobTopicSections.store', 'id' => 'job_topic_section_create']) !!}

            @include('job_topic_sections.create_fields')
