...
@section('scripts')
  ...
  <script>
    ...
    $('#job_topic_section_update').on('submit', function() {
      
      var job_topic_section_name = document.getElementById("name").value;
      
      if(job_topic_section_name.length >= 100)
      {
        alert("Invalid character number for the section name.");
        return false;
      }
      
      if(job_topic_section_name == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($jobTopicSection, ['route' => ['jobTopicSections.update', $jobTopicSection->id], 'method' => 'patch', 'id' => 'job_topic_section_update']) !!}

            @include('job_topic_sections.fields')
