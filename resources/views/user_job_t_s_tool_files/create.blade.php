...
@section('scripts')
  ...
  <script>
    ...
    $('#user_job_t_s_tool_file_create').on('submit', function() {
      
      var user_job_t_s_tool_file_description = document.getElementById("description").value;
      var user_job_t_s_tool_file_user_id = document.getElementById("user_id").value;
      
      if(user_job_t_s_tool_file_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_job_t_s_tool_file_description == '' || user_job_t_s_tool_file_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userJobTSToolFiles.store', 'id' => 'user_job_t_s_tool_file_create']) !!}

            @include('user_job_t_s_tool_files.create_fields')
