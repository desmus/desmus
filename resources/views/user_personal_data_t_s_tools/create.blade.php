...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_t_s_tool_create').on('submit', function() {
      
      var user_personal_data_t_s_tool_description = document.getElementById("description").value;
      var user_personal_data_t_s_tool_user_id = document.getElementById("user_id").value;
      
      if(user_personal_data_t_s_tool_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_personal_data_t_s_tool_description == '' || user_personal_data_t_s_tool_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userPersonalDataTSTools.store', 'id' => 'user_personal_data_t_s_tool_create']) !!}

            @include('user_personal_data_t_s_tools.create_fields')
