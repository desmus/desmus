    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('project_t_s_tool_files.show_fields')
                    
          <a href="{!! route('projectTSTools.show', [$projectTSToolFile -> project_t_s_t_id]) !!}" class="btn btn-default" style="margin-left: 20px">Back</a>
