...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_tool_file_update').on('submit', function() {
      ...
      if(project_t_s_tool_file_name == '' || project_t_s_tool_file_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($projectTSToolFile, ['route' => ['projectTSToolFiles.update', $projectTSToolFile->id], 'method' => 'patch', 'id' => 'project_t_s_tool_file_update']) !!}

            @include('project_t_s_tool_files.fields')
