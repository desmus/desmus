    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('project_t_s_files.show_fields')
          <a href="{!! route('projectTopicSections.show', [$projectTSFile -> project_topic_section_id]) !!}" class="btn btn-default" style="margin-left: 20px">Back</a>
