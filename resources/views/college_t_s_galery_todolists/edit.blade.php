...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_galery_todolist_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($collegeTSGaleryTodolist, ['route' => ['collegeTSGaleryTodolists.update', $collegeTSGaleryTodolist->id], 'method' => 'patch', 'id' => 'college_t_s_galery_todolist_update']) !!}
