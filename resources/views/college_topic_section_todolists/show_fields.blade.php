        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $collegeTopicSectionTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $collegeTopicSectionTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $collegeTopicSectionTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $collegeTopicSectionTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $collegeTopicSectionTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTopicSectionTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTopicSectionTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTopicSectionTodolistViews as $collegeTopicSectionTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTopicSectionTodolistView->name !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistView->email !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistView->datetime !!} </td>
                      ...
                      <div class="table-responsive">
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTopicSectionTodolistUpdates as $collegeTopicSectionTodolistUpdate)
  
                              <tr role="row" class="odd">
                              
                                <td class=""> {!! $collegeTopicSectionTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistUpdate->name !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistUpdate->email !!} </td>
                                <td class=""> {!! $collegeTopicSectionTodolistUpdate->datetime !!} </td>
