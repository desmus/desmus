...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_g_image_create').on('submit', function() {
      
      var user_project_t_s_g_image_description = document.getElementById("description").value;
      var user_project_t_s_g_image_user_id = document.getElementById("user_id").value;
      
      if(user_project_t_s_g_image_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_project_t_s_g_image_description == '' || user_project_t_s_g_image_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userProjectTSGaleryImages.store', 'id' => 'user_project_t_s_g_image_create']) !!}

            @include('user_project_t_s_galery_images.create_fields')
