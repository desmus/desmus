        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTSPTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTSPTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTSPTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTSPTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTSPTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSPTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSPTodolist -> updates_quantity !!} </h3>
                        ...
                        <tbody>
                          ...
                          @foreach($personalDataTSPTViews as $personalDataTSPTView)
                            ...
                            <tr role="row" class="odd">
                              ...
                              <td class=""> {!! $personalDataTSPTView->name !!} </td>
                              <td class=""> {!! $personalDataTSPTView->email !!} </td>
                              <td class=""> {!! $personalDataTSPTView->datetime !!} </td>
                        ...
                        <tbody>
                          ...
                          @foreach($personalDataTSPTUpdates as $personalDataTSPTUpdate)
                            ...
                            <tr role="row" class="odd">
                              ...
                              <td class=""> {!! $personalDataTSPTUpdate->actual_name !!} </td>
                              <td class=""> {!! $personalDataTSPTUpdate->past_name !!} </td>
                              <td class=""> {!! $personalDataTSPTUpdate->name !!} </td>
                              <td class=""> {!! $personalDataTSPTUpdate->email !!} </td>
                              <td class=""> {!! $personalDataTSPTUpdate->datetime !!} </td>
