...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_t_s_p_todolist_update').on('submit', function() {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $personalDataTSPTodolist -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($personalDataTSPTodolist, ['route' => ['personalDataTSPTodolists.update', $personalDataTSPTodolist->id], 'method' => 'patch', 'id' => 'personal_data_t_s_p_todolist_update']) !!}
