...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_note_update').on('submit', function() {
      
      var user_project_t_s_note_permissions = document.getElementById("description").value;
      
      if(user_project_t_s_note_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSNote[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSNote, ['route' => ['userProjectTSNotes.update', $userProjectTSNote[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_note_update']) !!}

            @include('user_project_t_s_notes.fields')
