...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_image_update').on('submit', function() {
      ...
      if(shared_profile_image_name == '' || shared_profile_image_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($sharedProfileImage, ['route' => ['sharedProfileImages.update', $sharedProfileImage->id], 'method' => 'patch', 'id' => 'shared_profile_image_update']) !!}
            
            @include('shared_profile_images.fields')
