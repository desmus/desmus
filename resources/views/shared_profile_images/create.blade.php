...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_image_create').on('submit', function() {
      
      var shared_profile_image_name = document.getElementById("name").value;
      var shared_profile_image_description = document.getElementById("description").value;
      var shared_profile_image_file = document.getElementById("image").value;
      var extension = shared_profile_image_file.split('.').pop();
      
      if(shared_profile_image_name.length >= 100)
      {
        alert("Invalid character number for the image name.");
        return false;
      }
      
      if(shared_profile_image_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(shared_profile_image_name == '' || shared_profile_image_description == '' || shared_profile_image_file == '')
      {
      ...
      if(shared_profile_image_name != '' && shared_profile_image_description != '' && shared_profile_image_file != '' && (extension == 'jpg' || extension == 'jpeg' || extension == 'bmp' || extension == 'gif' || extension == 'png'))
      {
        return true;
      }
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <form id = 'shared_profile_image_create' action = "{!! URL::to('/store_shared_profile_image') !!}" enctype = "multipart/form-data" method = "post">
            
            {{ csrf_field() }}

            @include('shared_profile_images.create_fields')
