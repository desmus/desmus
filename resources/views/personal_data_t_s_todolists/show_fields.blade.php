        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTSTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTSTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTSTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTSTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTSTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSTodolistViews as $personalDataTSTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTSTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTSTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSTodolistUpdates as $personalDataTSTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTSTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTSTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTSTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTSTodolistUpdate->datetime !!} </td>
