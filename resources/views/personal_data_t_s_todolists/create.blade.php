...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_topic_section_todolist_create').on('submit', function() {
      ...
      var personal_data_topic_section_todolist_status = document.getElementById("status").value;
      var personal_data_topic_section_todolist_datetime = document.getElementById("datetime").value;
      
      var date_format = /^(\d{4})-(\d{1,2})-(\d{1,2})$/;
      
      if(personal_data_topic_section_todolist_name.length >= 100)
      {
        alert("Invalid character number for the task name.");
        return false;
      }
      
      if(personal_data_topic_section_todolist_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
  
      if(personal_data_topic_section_todolist_datetime != '')
      {
        if(date_formats = personal_data_topic_section_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + personal_data_topic_section_todolist_datetime);
          return false;
        }
      }
      
      if(personal_data_topic_section_todolist_name == '' || personal_data_topic_section_todolist_description == '' || personal_data_topic_section_todolist_status == '' || personal_data_topic_section_todolist_datetime == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> PersonalData Topic Section Todolist </h1>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'personalDataTSTodolists.store', 'id' => 'personal_data_topic_section_todolist_create']) !!}
            ...
            @include('personal_data_t_s_todolists.fields')
