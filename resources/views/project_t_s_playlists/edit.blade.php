...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_playlist_update').on('submit', function() {
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            {!! Form::model($projectTSPlaylist, ['route' => ['projectTSPlaylists.update', $projectTSPlaylist->id], 'method' => 'patch',  'id' => 'project_t_s_playlist_update']) !!}
            
              @include('project_t_s_playlists.fields')
