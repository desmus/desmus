...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTopicSection[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_topic_sections.show_fields')
          <a href="{!! route('collegeTopics.show', [$collegeTopicSection[0] -> college_topic_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
