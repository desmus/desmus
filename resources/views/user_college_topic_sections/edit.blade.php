...
@section('scripts')
  ...
  <script>
    ...
    $('#user_college_topic_section_update').on('submit', function() {
      
      var user_college_topic_section_permissions = document.getElementById("permissions").value;
      
      if(user_college_topic_section_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userCollegeTopicSection[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userCollegeTopicSection, ['route' => ['userCollegeTopicSections.update', $userCollegeTopicSection[0]->id], 'method' => 'patch', 'id' => 'user_college_topic_section_update']) !!}

            @include('user_college_topic_sections.fields')
