...
@section('scripts')
  ...
  <script>
    ...
    $('#public_image_update').on('submit', function() {
      ...
      if(public_image_name == '' || public_image_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($publicImage, ['route' => ['publicImages.update', $publicImage->id], 'method' => 'patch', 'id' => 'public_image_update']) !!}
            
            @include('public_images.fields')
