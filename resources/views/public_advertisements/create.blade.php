...
@section('scripts')
  ...
  <script>
    ...
    $('#public_advertisement_create').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <form id = 'public_advertisement_create' action = "{!! URL::to('/store_public_advertisement') !!}" enctype = "multipart/form-data" method = "post">
            
            {{ csrf_field() }}

            @include('public_advertisements.create_fields')
