...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_t_s_note_update').on('submit', function() {
      
      var user_personal_data_t_s_note_permissions = document.getElementById("description").value;
      
      if(user_personal_data_t_s_note_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userPersonalDataTSNote[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userPersonalDataTSNote, ['route' => ['userPersonalDataTSNotes.update', $userPersonalDataTSNote[0]->id], 'method' => 'patch', 'id' => 'user_personal_data_t_s_note_update']) !!}

            @include('user_personal_data_t_s_notes.fields')
