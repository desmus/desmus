...
<div class="form-group col-sm-12">
  ...
  {!! Form::select('user_id', $select, null, ['class'=>'form-control']) !!}
</div>
...
{!! Form::hidden('personal_data_t_s_note_id', 'PersonalData Topic Section Note Id:') !!}
{!! Form::hidden('personal_data_t_s_note_id', $id, ['class' => 'form-control']) !!}
