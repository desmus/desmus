...
<div class="form-group col-sm-12">
  ...
  {!! Form::file('image', null, ['class' => 'form-control'], array('required' => 'required', 'id' => 'file')) !!}
</div>
...
{!! Form::hidden('college_t_s_g_id', 'College T S G Id:') !!}
{!! Form::hidden('college_t_s_g_id', $id, ['class' => 'form-control']) !!}

<div class="form-group col-sm-12" style="margin-bottom: 0;">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('collegeTSGaleries.show', [$id]) !!}" class="btn btn-default">Cancel</a>
</div>