...
@section('scripts')
  ...
  <script>
    ...
    $('#project_t_s_p_todolist_create').on('submit', function() {
      ...
      if(project_t_s_p_todolist_datetime != '')
      {
        if(date_formats = project_t_s_p_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + project_t_s_p_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Project Topic Section Playlist Todolist </h1>
