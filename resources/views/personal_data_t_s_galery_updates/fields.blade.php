...
<div class="form-group col-sm-6">
  {!! Form::label('p_d_t_s_g_id', 'P D T S G Id:') !!}
  {!! Form::number('p_d_t_s_g_id', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-12">
  {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
  <a href="{!! route('personalDataTSGaleryUpdates.index') !!}" class="btn btn-default">Cancel</a>
</div>