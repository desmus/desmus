...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $jobTSFile[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_job_t_s_files.show_fields')
          <a href="{!! route('jobTopicSections.show', [$jobTSFile[0] -> job_topic_section_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
