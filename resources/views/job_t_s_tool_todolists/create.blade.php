...
@section('scripts')
  ...
  <script>
    ...
    $('#job_t_s_tool_todolist_create').on('submit', function() {
      ...
      if(job_t_s_tool_todolist_datetime != '')
      {
        if(date_formats = job_t_s_tool_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + job_t_s_tool_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Job Topic Section Tool Todolist </h1>
