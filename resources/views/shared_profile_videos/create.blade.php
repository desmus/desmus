...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_video_create').on('submit', function() {
      
      var shared_profile_video_name = document.getElementById("name").value;
      var shared_profile_video_description = document.getElementById("description").value;
      var shared_profile_video_link = document.getElementById("link").value;
      var shared_profile_video_file = document.getElementById("file").value;
      var extension = shared_profile_video_file.split('.').pop();
      
      if(shared_profile_video_name.length >= 100)
      {
        alert("Invalid character number for the audio name.");
        return false;
      }
      
      if(shared_profile_video_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(shared_profile_video_name == '' || shared_profile_video_description == '' || shared_profile_video_link == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <form id = 'shared_profile_video_create' action = "{!! URL::to('/store_shared_profile_video') !!}" enctype = "multipart/form-data" method = "post">
            
            {{ csrf_field() }}

            @include('shared_profile_videos.create_fields')
