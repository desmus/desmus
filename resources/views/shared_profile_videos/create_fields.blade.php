...
<div class="form-group col-sm-12">
  ...
  {!! Form::text('link', 'Add a video link ...', ['class' => 'form-control'], array('required' => 'required', 'id' => 'link')) !!}
</div>
...
<div class="form-group col-sm-12" style="margin-bottom: 0;">
  ...
  <a href="{!! route('sharedProfileVideos.index') !!}" class="btn btn-default">Cancel</a>
</div>