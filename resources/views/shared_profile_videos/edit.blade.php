...
@section('scripts')
  ...
  <script>
    ...
    $('#shared_profile_video_update').on('submit', function() {
      ...
      if(shared_profile_video_name == '' || shared_profile_video_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($sharedProfileVideo, ['route' => ['sharedProfileVideos.update', $sharedProfileVideo->id], 'method' => 'patch', 'id' => 'shared_profile_video_update']) !!}
          
            @include('shared_profile_videos.fields')
