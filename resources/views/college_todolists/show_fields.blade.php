        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $collegeTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $collegeTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $collegeTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $collegeTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $collegeTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTodolistViews as $collegeTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTodolistView->name !!} </td>
                                <td class=""> {!! $collegeTodolistView->email !!} </td>
                                <td class=""> {!! $collegeTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTodolistUpdates as $collegeTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $collegeTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $collegeTodolistUpdate->name !!} </td>
                                <td class=""> {!! $collegeTodolistUpdate->email !!} </td>
                                <td class=""> {!! $collegeTodolistUpdate->datetime !!} </td>
