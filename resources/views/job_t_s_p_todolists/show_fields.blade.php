        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $jobTSPTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $jobTSPTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $jobTSPTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $jobTSPTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $jobTSPTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTSPTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTSPTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTSPTViews as $jobTSPTView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTSPTView->name !!} </td>
                                <td class=""> {!! $jobTSPTView->email !!} </td>
                                <td class=""> {!! $jobTSPTView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTSPTUpdates as $jobTSPTUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTSPTUpdate->actual_name !!} </td>
                                <td class=""> {!! $jobTSPTUpdate->past_name !!} </td>
                                <td class=""> {!! $jobTSPTUpdate->name !!} </td>
                                <td class=""> {!! $jobTSPTUpdate->email !!} </td>
                                <td class=""> {!! $jobTSPTUpdate->datetime !!} </td>
