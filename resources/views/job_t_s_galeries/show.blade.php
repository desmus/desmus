...
@section('scripts')
  ...
  <script>
    ...
    $('#job_t_s_galery_todolist_create').on('submit', function() {
      ...
      if(job_t_s_galery_todolist_name == '' || job_t_s_galery_todolist_description == '' || job_t_s_galery_todolist_datetime == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('job_t_s_galeries.show_fields')
                    
          <a href="{!! route('jobTopicSections.show', [$jobTSGalerie -> job_topic_section_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
