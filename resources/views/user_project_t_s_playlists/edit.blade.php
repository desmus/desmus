...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_playlist_update').on('submit', function() {
      
      var user_project_t_s_playlist_permissions = document.getElementById("description").value;
      
      if(user_project_t_s_playlist_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSPlaylist[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSPlaylist, ['route' => ['userProjectTSPlaylists.update', $userProjectTSPlaylist[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_playlist_update']) !!}

            @include('user_project_t_s_playlists.fields')
