...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTSPlaylist[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_t_s_playlists.show_fields')
          <a href="{!! route('collegeTopicSections.show', [$collegeTSPlaylist[0] -> c_t_s_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
