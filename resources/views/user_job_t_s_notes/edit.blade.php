...
@section('scripts')
  ...
  <script>
    ...
    $('#user_job_t_s_note_update').on('submit', function() {
      
      var user_job_t_s_note_permissions = document.getElementById("description").value;
      
      if(user_job_t_s_note_permissions == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userJobTSNote, ['route' => ['userJobTSNotes.update', $userJobTSNote[0]->id], 'method' => 'patch', 'id' => 'user_job_t_s_note_update']) !!}

            @include('user_job_t_s_notes.fields')
