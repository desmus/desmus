...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $jobTopicSection[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_job_topic_sections.show_fields')
          <a href="{!! route('jobTopics.show', [$jobTopicSection[0] -> job_topic_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
