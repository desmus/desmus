...
@section('scripts')
  ...
  <script>
    ...
    $('#user_job_topic_section_create').on('submit', function() {
      
      var user_job_topic_section_description = document.getElementById("description").value;
      var user_job_topic_section_user_id = document.getElementById("user_id").value;
      
      if(user_job_topic_section_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_job_topic_section_description == '' || user_job_topic_section_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userJobTopicSections.store', 'id' => 'user_job_topic_section_create']) !!}

            @include('user_job_topic_sections.create_fields')
