...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_create').on('submit', function() {
      
      var user_project_description = document.getElementById("description").value;
      var user_project_user_id = document.getElementById("user_id").value;
      
      if(user_project_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_project_description == '' || user_project_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userProjects.store', 'id' => 'user_project_create']) !!}

            @include('user_projects.create_fields')
