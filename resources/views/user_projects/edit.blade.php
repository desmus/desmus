...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_update').on('submit', function() {
      
      var user_project_permissions = document.getElementById("permissions").value;
      
      if(user_project_permissions == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProject, ['route' => ['userProjects.update', $userProject[0]->id], 'method' => 'patch', 'id' => 'user_project_update']) !!}

            @include('user_projects.fields')
