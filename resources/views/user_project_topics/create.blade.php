...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_topic_create').on('submit', function() {
      
      var user_project_topic_description = document.getElementById("description").value;
      var user_project_topic_user_id = document.getElementById("user_id").value;
      
      if(user_project_topic_description.length >= 190)
      {
        alert("Invalid character number for the description.");
        return false;
      }
      
      if(user_project_topic_description == '' || user_project_topic_user_id == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'userProjectTopics.store', 'id' => 'user_project_topic_create']) !!}

            @include('user_project_topics.create_fields')
