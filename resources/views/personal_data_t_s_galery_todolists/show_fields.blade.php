        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $personalDataTSGaleryTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $personalDataTSGaleryTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $personalDataTSGaleryTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $personalDataTSGaleryTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $personalDataTSGaleryTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSGaleryTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $personalDataTSGaleryTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSGaleryTodolistViews as $personalDataTSGaleryTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $personalDataTSGaleryTodolistView->name !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistView->email !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistView->datetime !!} </td>
                      ...
                      <div class="table-responsive">
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                          ...
                          <tbody>
                            ...
                            @foreach($personalDataTSGaleryTodolistUpdates as $personalDataTSGaleryTodolistUpdate)
  
                              <tr role="row" class="odd">
                              
                                <td class=""> {!! $personalDataTSGaleryTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistUpdate->name !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistUpdate->email !!} </td>
                                <td class=""> {!! $personalDataTSGaleryTodolistUpdate->datetime !!} </td>
