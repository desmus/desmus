...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $collegeTSPAudio[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('user_college_t_s_p_audios.show_fields')
          <a href="{!! route('collegeTSPAudios.show', [$collegeTSPAudio[0] -> id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
