...
@section('scripts')
  ...
  <script>
    ...
    $('#job_topic_todolist_update').on('submit', function() {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($jobTopicTodolist, ['route' => ['jobTopicTodolists.update', $jobTopicTodolist->id], 'method' => 'patch', 'id' => 'job_topic_todolist_update']) !!}

            @include('job_topic_todolists.fields')
