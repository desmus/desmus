        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $jobTopicTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $jobTopicTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $jobTopicTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $jobTopicTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $jobTopicTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTopicTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTopicTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTopicTodolistViews as $jobTopicTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTopicTodolistView->name !!} </td>
                                <td class=""> {!! $jobTopicTodolistView->email !!} </td>
                                <td class=""> {!! $jobTopicTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTopicTodolistUpdates as $jobTopicTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTopicTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $jobTopicTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $jobTopicTodolistUpdate->name !!} </td>
                                <td class=""> {!! $jobTopicTodolistUpdate->email !!} </td>
                                <td class=""> {!! $jobTopicTodolistUpdate->datetime !!} </td>
