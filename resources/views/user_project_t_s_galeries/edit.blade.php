...
@section('scripts')
  ...
  <script>
    ...
    $('#user_project_t_s_galery_update').on('submit', function() {
      
      var user_project_t_s_galery_permissions = document.getElementById("description").value;
      
      if(user_project_t_s_galery_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userProjectTSGalerie[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userProjectTSGalerie, ['route' => ['userProjectTSGaleries.update', $userProjectTSGalerie[0]->id], 'method' => 'patch', 'id' => 'user_project_t_s_galery_update']) !!}

            @include('user_project_t_s_galeries.fields')
