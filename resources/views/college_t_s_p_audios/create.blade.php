...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_p_audio_create').on('submit', function() {
      ...
      var college_t_s_p_audio_file = document.getElementById("file").value;
      var extension = college_t_s_p_audio_file.split('.').pop();
      ...
      if(college_t_s_p_audio_name == '' || college_t_s_p_audio_description == '' || college_t_s_p_audio_file == '')
      {
      ...
      if(college_t_s_p_audio_name != '' && college_t_s_p_audio_description != '' && college_t_s_p_audio_file != '' && (extension == '3gp' || extension == 'aa' || extension == 'aac' || extension == 'aax' || extension == 'act' || extension == 'aiff' || extension == 'amr' || extension == 'ape' || extension == 'au' || extension == 'awb' || extension == 'dct' || extension == 'dss' || extension == 'dvf' || extension == 'flac' || extension == 'gsm' || extension == 'iklax' || extension == 'ivs' || extension == 'm4a' || extension == 'm4b' || extension == 'm4p' || extension == 'mmf' || extension == 'mp3' || extension == 'mpc' || extension == 'msv' || extension == 'nsf' || extension == 'ogg' || extension == 'oga' || extension == 'mogg' || extension == 'opus' || extension == 'ra' || extension == 'rm' || extension == 'raw' || extension == 'sln' || extension == 'tta' || extension == 'vox' || extension == 'wav' || extension == 'wma' || extension == 'wv' || extension == 'webm' || extension == '8svx'))
      {
        return true;
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> College Topic Section Playlist Audio </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <form id = 'college_t_s_p_audio_create' action = "{!! URL::to('/store_college_audio') !!}" enctype = "multipart/form-data" method = "post">
            
            {{ csrf_field() }}

            @include('college_t_s_p_audios.create_fields')
  ...
  <aside class="control-sidebar control-sidebar-dark control-sidebar-close" style="background: rgba(0,0,0,0.8);">
    ...
    <div class="tab-content" style="padding: 20px;">
      ...
      <div class="tab-pane active" id="galeries">
        ...
        <h3 class="control-sidebar-heading" style="margin-top: 0; border-bottom: 1px solid rgba(255,255,255,0.3);"> College Audios </h3>
