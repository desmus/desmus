    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('college_t_s_p_audios.show_fields')
          <a href="{!! route('collegeTSPlaylists.show', [$collegeTSPAudio -> c_t_s_p_id]) !!}" class="btn btn-default" style="margin-left: 20px">Back</a>
