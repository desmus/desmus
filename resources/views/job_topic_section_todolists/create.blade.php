...
@section('scripts')
  ...
  <script>
    ...
    $('#job_topic_section_todolist_create').on('submit', function() {
      ...
      if(job_topic_section_todolist_datetime != '')
      {
        if(date_formats = job_topic_section_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + job_topic_section_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> Job Topic Section Todolist </h1>
