        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $jobTopicSectionTodolist->name !!}</p>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $jobTopicSectionTodolist->description !!}</p>
            </div>
            
            <!-- Datetime Field -->
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $jobTopicSectionTodolist->datetime !!}</p>
            </div>
            
            <!-- Created At Field -->
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $jobTopicSectionTodolist->created_at !!}</p>
            </div>
            
            <!-- Updated At Field -->
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $jobTopicSectionTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTopicSectionTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $jobTopicSectionTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTopicSectionTodolistViews as $jobTopicSectionTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTopicSectionTodolistView->name !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistView->email !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($jobTopicSectionTodolistUpdates as $jobTopicSectionTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $jobTopicSectionTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistUpdate->name !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistUpdate->email !!} </td>
                                <td class=""> {!! $jobTopicSectionTodolistUpdate->datetime !!} </td>
