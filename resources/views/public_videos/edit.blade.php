...
@section('scripts')
  ...
  <script>
    ...
    $('#public_video_update').on('submit', function() {
      ...
      if(public_video_name == '' || public_video_description == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($publicVideo, ['route' => ['publicVideos.update', $publicVideo->id], 'method' => 'patch', 'id' => 'public_video_update']) !!}
          
            @include('public_videos.fields')
