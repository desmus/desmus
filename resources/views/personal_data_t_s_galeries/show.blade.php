...
@section('scripts')
  ...
  <script>
    ...
    $('#personal_data_t_s_galery_todolist_create').on('submit', function() {
      ...
      if(personal_data_t_s_galery_todolist_name == '' || personal_data_t_s_galery_todolist_description == '' || personal_data_t_s_galery_todolist_datetime == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          @include('personal_data_t_s_galeries.show_fields')
                    
          <a href="{!! route('personalDataTopicSections.show', [$personalDataTSGalerie -> personal_data_t_s_id]) !!}" class="btn btn-default" style="margin-left: 20px;">Back</a>
