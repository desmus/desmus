...
@section('scripts')
  ...
  <script>
    ...
    $('#user_personal_data_t_s_galery_update').on('submit', function() {
      
      var user_personal_data_t_s_galery_permissions = document.getElementById("description").value;
      
      if(user_personal_data_t_s_galery_permissions == '')
      {
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!!$userPersonalDataTSGalerie[0] -> name !!} </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userPersonalDataTSGalerie, ['route' => ['userPersonalDataTSGaleries.update', $userPersonalDataTSGalerie[0]->id], 'method' => 'patch', 'id' => 'user_personal_data_t_s_galery_update']) !!}

            @include('user_personal_data_t_s_galeries.fields')
