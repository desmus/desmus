...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_note_todolist_create').on('submit', function() {
      ...
      if(college_t_s_note_todolist_name.length >= 100)
      {
        alert("Invalid character number for the task name.");
        return false;
      }
      
      if(college_t_s_note_todolist_description.length >= 1000)
      {
        alert("Invalid character number for the description.");
        return false;
      }
  
      if(college_t_s_note_todolist_datetime != '')
      {
        if(date_formats = college_t_s_note_todolist_datetime.match(date_format))
        {
        ...
        {
          alert("Invalid date format: " + college_t_s_note_todolist_datetime);
          return false;
        }
      }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> College Topic Section Note Todolist </h1>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::open(['route' => 'collegeTSNoteTodolists.store', 'id' => 'college_t_s_note_todolist_create']) !!}
            ...
            @include('college_t_s_note_todolists.fields')
