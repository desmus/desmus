        ...
        <div class="tab-content clearfix">
          ...
          <div class = "tab-pane active" id = "todolist_info">
            ...
            <div class="form-group">
                ...
                <p>{!! $collegeTSNoteTodolist->name !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('description', 'Description:') !!}
                <p>{!! $collegeTSNoteTodolist->description !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('datetime', 'Datetime:') !!}
                <p>{!! $collegeTSNoteTodolist->datetime !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('created_at', 'Created At:') !!}
                <p>{!! $collegeTSNoteTodolist->created_at !!}</p>
            </div>
            
            <div class="form-group">
                {!! Form::label('updated_at', 'Updated At:') !!}
                <p>{!! $collegeTSNoteTodolist->updated_at !!}</p>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTSNoteTodolist -> views_quantity !!} <sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <div class="inner">
                  ...
                  <h3> {!! $collegeTSNoteTodolist -> updates_quantity !!} </h3>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTSNoteTodolistViews as $collegeTSNoteTodolistView)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTSNoteTodolistView->name !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistView->email !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistView->datetime !!} </td>
                          ...
                          <tbody>
                            ...
                            @foreach($collegeTSNoteTodolistUpdates as $collegeTSNoteTodolistUpdate)
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td class=""> {!! $collegeTSNoteTodolistUpdate->actual_name !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistUpdate->past_name !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistUpdate->name !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistUpdate->email !!} </td>
                                <td class=""> {!! $collegeTSNoteTodolistUpdate->datetime !!} </td>
