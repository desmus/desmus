...
@section('scripts')
  ...
  <script>
    ...
    $('#user_job_t_s_p_audio_update').on('submit', function() {
      
      var user_job_t_s_p_audio_permissions = document.getElementById("description").value;
      
      if(user_job_t_s_p_audio_permissions == '')
      {
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          {!! Form::model($userJobTSPAudio, ['route' => ['userJobTSPAudios.update', $userJobTSPAudio[0]->id], 'method' => 'patch', 'id' => 'user_job_t_s_p_audio_update']) !!}

            @include('user_job_t_s_p_audios.fields')
